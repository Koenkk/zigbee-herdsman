...
= {
    ...
    manuSpecificInovelliVZM31SN: {
        ...
        attributes: {
            dimming_speed_up_remote: {ID: 0x001, type: DataType.uint8},
            dimming_speed_up_local: {ID: 0x0002, type: DataType.uint8},
            ramp_rate_off_to_on_remote: {ID: 0x0003, type: DataType.uint8},
            ramp_rate_off_to_on_local: {ID: 0x0004, type: DataType.uint8},
            dimming_speed_down_remote: {ID: 0x0005 , type: DataType.uint8},
            dimming_speed_down_local: {ID: 0x0006, type: DataType.uint8},
            ramp_rate_on_to_off_remote: {ID: 0x0007, type: DataType.uint8},
            ramp_rate_on_to_off_local: {ID: 0x0008, type: DataType.uint8},
            minimum_level: {ID: 0x0009, type: DataType.uint8},
            maximum_level: {ID: 0x000a, type: DataType.uint8},
            invert_switch: {ID: 0x000b, type: DataType.boolean},
            auto_timer_off: {ID: 0x000c, type: DataType.uint16},
            default_level_local: {ID: 0x000d, type: DataType.uint8},
            default_level_remote: {ID: 0x000e, type: DataType.uint8},
            state_after_power_restored: {ID: 0x000f, type: DataType.uint8},
            load_level_indicator_timeout: {ID: 0x0011, type: DataType.uint8},
            active_power_reports: {ID: 0x0012, type: DataType.uint16},
            periodic_power_and_energy_reports: {
                ID: 0x0013,
                type: DataType.uint16,
            },
            active_energy_reports: {ID: 0x0014, type: DataType.uint16},
            power_type: {ID: 0x0015, type: DataType.boolean},
            switch_type: {ID: 0x0016, type: DataType.uint8},
            button_delay: {ID: 0x0032, type: DataType.uint8},
            device_bind_number: {ID: 0x0033, type: DataType.uint8},
            smart_bulb_mode: {ID: 0x0034, type: DataType.boolean},
            double_tap_up_for_full_brightness: {ID: 0x0035, type: DataType.boolean},
            default_led_1_color_when_on: {ID: 0x003c, type: DataType.uint8},
            default_led_1_color_when_off: {ID: 0x003d, type: DataType.uint8},
            default_led_1_intensity_when_on: {ID: 0x003e, type: DataType.uint8},
            default_led_1_intensity_when_off: {ID: 0x003f, type: DataType.uint8},
            default_led_2_color_when_on: {ID: 0x0041, type: DataType.uint8},
            default_led_2_color_when_off: {ID: 0x0042, type: DataType.uint8},
            default_led_2_intensity_when_on: {ID: 0x0043, type: DataType.uint8},
            default_led_2_intensity_when_off: {ID: 0x0044, type: DataType.uint8},
            default_led_3_color_when_on: {ID: 0x0046, type: DataType.uint8},
            default_led_3_color_when_off: {ID: 0x0047, type: DataType.uint8},
            default_led_3_intensity_when_on: {ID: 0x0048, type: DataType.uint8},
            default_led_3_intensity_when_off: {ID: 0x0049, type: DataType.uint8},
            default_led_4_color_when_on: {ID: 0x004b, type: DataType.uint8},
            default_led_4_color_when_off: {ID: 0x004c, type: DataType.uint8},
            default_led_4_intensity_when_on: {ID: 0x004d, type: DataType.uint8},
            default_led_4_intensity_when_off: {ID: 0x004e, type: DataType.uint8},
            default_led_5_color_when_on: {ID: 0x0050, type: DataType.uint8},
            default_led_5_color_when_off: {ID: 0x0051, type: DataType.uint8},
            default_led_5_intensity_when_on: {ID: 0x0052, type: DataType.uint8},
            default_led_5_intensity_when_off: {ID: 0x0053, type: DataType.uint8},
            default_led_6_color_when_on: {ID: 0x0055, type: DataType.uint8},
            default_led_6_color_when_off: {ID: 0x0056, type: DataType.uint8},
            default_led_6_intensity_when_on: {ID: 0x0057, type: DataType.uint8},
            default_led_6_intensity_when_off: {ID: 0x0058, type: DataType.uint8},
            default_led_7_color_when_on: {ID: 0x005a, type: DataType.uint8},
            default_led_7_color_when_off: {ID: 0x005b, type: DataType.uint8},
            default_led_7_intensity_when_on: {ID: 0x005c, type: DataType.uint8},
            default_led_7_intensity_when_off: {ID: 0x005d, type: DataType.uint8},
            led_color_when_on: {ID: 0x005f, type: DataType.uint8},
            led_color_when_off: {ID: 0x060, type: DataType.uint8},
            led_intensity_when_on: {ID: 0x0061, type: DataType.uint8},
            led_intensity_when_off: {
                ID: 0x0062,
                type: DataType.uint8,
            },
            local_protection: {ID: 0x0100, type: DataType.boolean},
            remote_protection: {ID: 0x0101, type: DataType.boolean},
            output_mode: {ID: 0x0102, type: DataType.boolean},
            on_off_led_mode: {ID: 0x0103, type: DataType.boolean},
            firmware_update_in_progress_indicator:{ID: 0x0104, type: DataType.boolean},
        },
        commands: {
            led_effect: {
                ID: 1,
