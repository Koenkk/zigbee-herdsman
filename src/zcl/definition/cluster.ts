...
= {
    ...
    seMetering: {
        ...
        attributes: {
			...
			owonL1PhaseVoltage: {ID: 0x3000, type: DataType.int24u,manufacturerCode: ManufacturerCode.OWON},
			owonL2PhaseVoltage: {ID: 0x3001, type: DataType.int24u,manufacturerCode: ManufacturerCode.OWON},
			owonL3PhaseVoltage: {ID: 0x3002, type: DataType.int24u,manufacturerCode: ManufacturerCode.OWON},
			owonL1PhaseCurrent: {ID: 0x3100, type: DataType.int24u,manufacturerCode: ManufacturerCode.OWON},
			owonL2PhaseCurrent: {ID: 0x3101, type: DataType.int24u,manufacturerCode: ManufacturerCode.OWON},
			owonL3PhaseCurrent: {ID: 0x3102, type: DataType.int24u,manufacturerCode: ManufacturerCode.OWON},
			owonCurrentSum: {ID: 0x3103, type: DataType.int24u,manufacturerCode: ManufacturerCode.OWON},
			owonLeakageCurrent: {ID: 0x3104, type: DataType.int24u,manufacturerCode: ManufacturerCode.OWON},
			owonL1Energy: {ID: 0x4000, type: DataType.int48u,manufacturerCode: ManufacturerCode.OWON},
			owonL2Energy: {ID: 0x4001, type: DataType.int48u,manufacturerCode: ManufacturerCode.OWON},
			owonL3Energy: {ID: 0x4002, type: DataType.int48u,manufacturerCode: ManufacturerCode.OWON},
			owonL1ReactiveEnergy: {ID: 0x4100, type: DataType.int48u,manufacturerCode: ManufacturerCode.OWON},
			owonL2ReactiveEnergy: {ID: 0x4101, type: DataType.int48u,manufacturerCode: ManufacturerCode.OWON},
			owonL3ReactiveEnergy: {ID: 0x4102, type: DataType.int48u,manufacturerCode: ManufacturerCode.OWON},
			owonReactiveEnergySum: {ID: 0x4103, type: DataType.int48u,manufacturerCode: ManufacturerCode.OWON},
			owonFrequency: {ID: 0x5005, type: DataType.int8u,manufacturerCode: ManufacturerCode.OWON},
