        ...
        commands: {
            arm: {
                ...
                parameters: [
                    ...
                    {name: 'unknown1', type: DataType.default.uint8 },
                    {name: 'u1', type: DataType.default.uint8 },
                    {name: 'u2', type: DataType.default.uint8 },
                    {name: 'u3', type: DataType.default.uint8 },
                    {name: 'u4', type: DataType.default.uint8 },
                    {name: 'u5', type: DataType.default.uint8 },
                    {name: 'u6', type: DataType.default.uint8 },
                ],
            },
            bypass: {
                ID: 1,
