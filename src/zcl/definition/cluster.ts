        ...
        commands: {
            arm: {
                ...
                parameters: [
                    ...
                    {name: 'unknown1', type: DataType.uint8},
                    {name: 'u1', type: DataType.uint8},
                    {name: 'u2', type: DataType.uint8},
                    {name: 'u3', type: DataType.uint8},
                    {name: 'u4', type: DataType.uint8},
                    {name: 'u5', type: DataType.uint8},
                    {name: 'u6', type: DataType.uint8},
                ],
            },
            bypass: {
                ID: 1,
