...
= {
    ...
    manuSpecificInovelliVZM31SN: {
        ...
        attributes: {
            dimming_speed_up_remote: {ID: 1, type: DataType.uint8},
            dimming_speed_up_local: {ID: 2, type: DataType.uint8},
            ramp_rate_off_to_on_remote: {ID: 3, type: DataType.uint8},
            ramp_rate_off_to_on_local: {ID: 4, type: DataType.uint8},
            dimming_speed_down_remote: {ID: 5 , type: DataType.uint8},
            dimming_speed_down_local: {ID: 6, type: DataType.uint8},
            ramp_rate_on_to_off_remote: {ID: 7, type: DataType.uint8},
            ramp_rate_on_to_off_local: {ID: 8, type: DataType.uint8},
            minimum_level: {ID: 9, type: DataType.uint8},
            maximum_level: {ID: 10, type: DataType.uint8},
            invert_switch: {ID: 11, type: DataType.boolean},
            auto_timer_off: {ID: 12, type: DataType.uint16},
            default_level_local: {ID: 13, type: DataType.uint8},
            default_level_remote: {ID: 14, type: DataType.uint8},
            state_after_power_restored: {ID: 15, type: DataType.uint8},
            load_level_indicator_timeout: {ID: 17, type: DataType.uint8},
            active_power_reports: {ID: 18, type: DataType.uint16},
            periodic_power_and_energy_reports: {
                ID: 19,
                type: DataType.uint16,
            },
            active_energy_reports: {ID: 20, type: DataType.uint16},
            power_type: {ID: 21, type: DataType.boolean},
            switch_type: {ID: 22, type: DataType.uint8},
            physical_on_off_delay: {ID: 50, type: DataType.uint8},
            smart_bulb_mode: {ID: 52, type: DataType.boolean},
            double_tap_up_event: {ID: 32, type: DataType.boolean},
      
            led_color_when_on: {ID: 95, type: DataType.uint8},
            led_color_when_off: {ID: 96, type: DataType.uint8},
            led_intensity_when_on: {ID: 97, type: DataType.uint8},
            led_intensity_when_off: {
                ID: 98,
                type: DataType.uint8,
            },
            local_protection: {ID: 256, type: DataType.boolean},
            remote_protection: {ID: 257, type: DataType.boolean},
            output_mode: {ID: 258, type: DataType.boolean},
            on_off_led_mode: {ID: 259, type: DataType.boolean},
            firmware_update_in_progress_indicator:{ID: 260, type: DataType.boolean},
            default_led_1_color_when_on: {ID: 60, type: DataType.uint8},
            default_led_1_color_when_off: {ID: 61, type: DataType.uint8},
            default_led_1_intensity_when_on: {ID: 62, type: DataType.uint8},
            default_led_1_intensity_when_off: {ID: 63, type: DataType.uint8},
            default_led_2_color_when_on: {ID: 65, type: DataType.uint8},
            default_led_2_color_when_off: {ID: 66, type: DataType.uint8},
            default_led_2_intensity_when_on: {ID: 67, type: DataType.uint8},
            default_led_2_intensity_when_off: {ID: 68, type: DataType.uint8},
            default_led_3_color_when_on: {ID: 70, type: DataType.uint8},
            default_led_3_color_when_off: {ID: 71, type: DataType.uint8},
            default_led_3_intensity_when_on: {ID: 72, type: DataType.uint8},
            default_led_3_intensity_when_off: {ID: 73, type: DataType.uint8},
            default_led_4_color_when_on: {ID: 75, type: DataType.uint8},
            default_led_4_color_when_off: {ID: 76, type: DataType.uint8},
            default_led_4_intensity_when_on: {ID: 77, type: DataType.uint8},
            default_led_4_intensity_when_off: {ID: 78, type: DataType.uint8},
            default_led_5_color_when_on: {ID: 80, type: DataType.uint8},
            default_led_5_color_when_off: {ID: 81, type: DataType.uint8},
            default_led_5_intensity_when_on: {ID: 82, type: DataType.uint8},
            default_led_5_intensity_when_off: {ID: 83, type: DataType.uint8},
            default_led_6_color_when_on: {ID: 85, type: DataType.uint8},
            default_led_6_color_when_off: {ID: 86, type: DataType.uint8},
            default_led_6_intensity_when_on: {ID: 87, type: DataType.uint8},
            default_led_6_intensity_when_off: {ID: 88, type: DataType.uint8},
            default_led_7_color_when_on: {ID: 90, type: DataType.uint8},
            default_led_7_color_when_off: {ID: 91, type: DataType.uint8},
            default_led_7_intensity_when_on: {ID: 92, type: DataType.uint8},
            default_led_7_intensity_when_off: {ID: 93, type: DataType.uint8}
        },
        commands: {
            led_effect: {
                ID: 1,
