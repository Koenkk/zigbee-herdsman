...
export const Endpoints = [
    ...
    {...EndpointDefaults, endpoint: 10, appprofid: 0x0104},
    {
        ...
        appdeviceid: 0x0400,
        appnumoutclusters: 2,
        appoutclusterlist: [Cluster.ssIasZone.ID, Cluster.ssIasWd.ID],
        appnuminclusters: 2,
        // genTime required for https://github.com/Koenkk/zigbee2mqtt/issues/10816
        appinclusterlist: [Cluster.ssIasAce.ID, Cluster.genTime.ID]
    ...
    {...EndpointDefaults, endpoint: 12, appprofid: 0xc05e},
    {
        ...
        appprofid: 0x0104,
        appnuminclusters: 1,
        appinclusterlist: [Cluster.genOta.ID]
    },
