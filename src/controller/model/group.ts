...
class Group extends Entity {
    ...
    public async write(
        ...
        const cluster = Zcl.Utils.getCluster(clusterKey, null, null);
        ...
        try {
            const frame = Zcl.ZclFrame.create(
                ...
                'write', cluster.ID, payload, null, options.reservedBits
            );
    ...
    public async read(
        ...
        const frame = Zcl.ZclFrame.create(
            ...
            cluster.ID, payload, null, options.reservedBits
        );
    ...
    public async command(
        ...
        try {
            const frame = Zcl.ZclFrame.create(
                ...
                command.ID, cluster.ID, payload, null, options.reservedBits
            );
            await Entity.adapter.sendZclFrameToGroup(this.groupID, frame, options.srcEndpoint);
        } catch (error) {
            error.message = `${log} failed (${error.message})`;
