...
export const Clusters: Readonly<Record<ClusterName, Readonly<ClusterDefinition>>> = {
    ...
    genDeviceTempCfg: {
        ...
        attributes: {
            ...
            lowTempThres: {ID: 0x0011, type: DataType.INT16, writable: true, min: -200, max: 200},
            highTempThres: {ID: 0x0012, type: DataType.INT16, writable: true, min: -200, max: 200},
    ...
    genLevelCtrl: {
        ...
        attributes: {
            ...
            onLevel: {ID: 0x0011, type: DataType.UINT8, writable: true, default: 0xff},
    ...
    genCommissioning: {
        ...
        attributes: {
            ...
            rejoinInterval: {ID: 0x0022, type: DataType.UINT16, writable: true, min: 1, default: 60},
    ...
    hvacDehumidificationCtrl: {
        ...
        attributes: {
            ...
            dehumidCooling: {ID: 0x0001, type: DataType.UINT8, reportRequired: true, required: true},
    ...
    lightingBallastCfg: {
        ...
        attributes: {
            ...
            powerOnLevel: {ID: 0x0012, type: DataType.UINT8, writable: true, max: 0xfe},
