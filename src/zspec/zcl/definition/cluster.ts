...
export const Clusters: Readonly<Record<ClusterName, Readonly<ClusterDefinition>>> = {
    genBasic: {
        ...
        attributes: {
            ...
            manufacturerName: {ID: 0x0004, type: DataType.CHAR_STR, default: "", maxLength: 32},
            modelId: {ID: 0x0005, type: DataType.CHAR_STR, default: "", maxLength: 32},
            dateCode: {ID: 0x0006, type: DataType.CHAR_STR, default: "", maxLength: 16},
            ...
            locationDesc: {ID: 0x0010, type: DataType.CHAR_STR, writable: true, default: "", maxLength: 16},
            ...
            swBuildId: {ID: 0x4000, type: DataType.CHAR_STR, default: "", maxLength: 16},
    ...
    genPowerCfg: {
        ...
        attributes: {
            ...
            batteryManufacturer: {ID: 0x0030, type: DataType.CHAR_STR, writable: true, default: "", maxLength: 16},
            ...
            battery2Manufacturer: {ID: 0x0050, type: DataType.CHAR_STR, writable: true, default: "", maxLength: 16},
            ...
            battery3Manufacturer: {ID: 0x0070, type: DataType.CHAR_STR, writable: true, default: "", maxLength: 16},
    ...
    genDeviceTempCfg: {
        ...
        attributes: {
            ...
            lowTempThres: {ID: 0x0011, type: DataType.INT16, writable: true, min: -200, max: 200, maxExclusiveRef: "highTempThres"},
            highTempThres: {ID: 0x0012, type: DataType.INT16, writable: true, min: -200, max: 200, minExclusiveRef: "lowTempThres"},
    ...
    genLevelCtrl: {
        ...
        attributes: {
            currentLevel: {
                ...
                required: true,
                default: 255,
                minInclusiveRef: "minLevel",
                maxInclusiveRef: "maxLevel",
            },
            remainingTime: {ID: 0x0001, type: DataType.UINT16, max: 65535, default: 0},
            minLevel: {ID: 0x0002, type: DataType.UINT8, default: 0, maxInclusiveRef: "maxLevel"},
            maxLevel: {ID: 0x0003, type: DataType.UINT8, max: 255, default: 255, minInclusiveRef: "minLevel"},
            currentFrequency: {
                ID: 0x0004,
                type: DataType.UINT16,
                reportRequired: true,
                sceneRequired: true,
                default: 0,
                minInclusiveRef: "minFrequency",
                maxInclusiveRef: "maxFrequency",
            },
            minFrequency: {ID: 0x0005, type: DataType.UINT16, default: 0, maxInclusiveRef: "maxFrequency"},
            maxFrequency: {ID: 0x0006, type: DataType.UINT16, max: 65535, default: 0, minInclusiveRef: "minFrequency"},
            ...
            onLevel: {ID: 0x0011, type: DataType.UINT8, writable: true, default: 255, minInclusiveRef: "minLevel", maxInclusiveRef: "maxLevel"},
    ...
    genCommissioning: {
        ...
        attributes: {
            ...
            rejoinInterval: {ID: 0x0022, type: DataType.UINT16, writable: true, min: 1, default: 60, maxInclusiveRef: "maxRejoinInterval"},
    ...
    pulseWidthModulation: {
        ...
        attributes: {
            ...
            remainingTime: {ID: 0x0001, type: DataType.UINT16, max: 65535, default: 0},
            minLevel: {ID: 0x0002, type: DataType.UINT8, default: 0, maxInclusiveRef: "maxLevel", required: true},
            maxLevel: {ID: 0x0003, type: DataType.UINT8, max: 100, default: 100, minInclusiveRef: "minLevel", required: true},
            currentFrequency: {
                ID: 0x0004,
                type: DataType.UINT16,
                reportRequired: true,
            ...
            minFrequency: {ID: 0x0005, type: DataType.UINT16, default: 0, maxInclusiveRef: "maxFrequency", required: true},
            maxFrequency: {ID: 0x0006, type: DataType.UINT16, max: 65535, default: 0, minInclusiveRef: "minFrequency", required: true},
            options: {ID: 0x000f, type: DataType.BITMAP8, writable: true, default: 0},
            onOffTransitionTime: {ID: 0x0010, type: DataType.UINT16, writable: true, max: 65535, default: 0},
            onLevel: {ID: 0x0011, type: DataType.UINT8, writable: true, default: 255, minInclusiveRef: "minLevel", maxInclusiveRef: "maxLevel"},
            onTransitionTime: {ID: 0x0012, type: DataType.UINT16, writable: true, max: 65534, default: 65535},
        ...
        commands: {
            ...
            setWeekDaySchedule: {
                ...
                parameters: [
                    ...
                    {name: "starthour", type: DataType.UINT8, minInclusive: 0, maxInclusive: 23},
                    {name: "startminute", type: DataType.UINT8, minInclusive: 0, maxInclusive: 59},
                    {name: "endhour", type: DataType.UINT8, minInclusive: 0, maxInclusive: 23},
                    {name: "endminute", type: DataType.UINT8, minInclusive: 0, maxInclusive: 59},
                ],
            },
            getWeekDaySchedule: {
                ID: 0x0c,
            ...
            setYearDaySchedule: {
                ...
                parameters: [
                    ...
                    {name: "zigbeelocalendtime", type: DataType.UINT32, minExclusiveRef: "zigbeelocalstarttime"},
                ],
            },
            getYearDaySchedule: {
                ID: 0x0f,
                ...
                parameters: [
                    {
                        name: "liftvalue",
                        type: DataType.UINT16,
                        minInclusiveRef: "installedClosedLimitLiftCm",
                        maxInclusiveRef: "installedOpenLimitLiftCm",
                    },
                ],
            },
            goToLiftPercentage: {ID: 0x05, parameters: [{name: "percentageliftvalue", type: DataType.UINT8, maxInclusive: 100}]},
            goToTiltValue: {
                ID: 0x07,
                parameters: [
                    {
                        name: "tiltvalue",
                        type: DataType.UINT16,
                        minInclusiveRef: "installedClosedLimitTiltDdegree",
                        maxInclusiveRef: "installedOpenLimitTiltDdegree",
                    },
                ],
            },
            goToTiltPercentage: {ID: 0x08, parameters: [{name: "percentagetiltvalue", type: DataType.UINT8, maxInclusive: 100}]},
    ...
    barrierControl: {
        ...
        commands: {
            goToPercent: {ID: 0x00, parameters: [{name: "percentOpen", type: DataType.UINT8, minInclusive: 0, maxInclusive: 100}], required: true},
    ...
    hvacThermostat: {
        ...
        attributes: {
            ...
            occupiedCoolingSetpoint: {
                ...
                sceneRequired: true,
                default: 2600,
                minInclusiveRef: "minCoolSetpointLimit",
                maxInclusiveRef: "maxCoolSetpointLimit",
            },
            occupiedHeatingSetpoint: {
                ...
                sceneRequired: true,
                default: 2000,
                minInclusiveRef: "minHeatSetpointLimit",
                maxInclusiveRef: "maxHeatSetpointLimit",
            },
            ...
            occupiedSetback: {
                ...
                writable: true,
                default: 255,
                minInclusiveRef: "occupiedSetbackMin",
                maxInclusiveRef: "occupiedSetbackMax",
            },
            occupiedSetbackMin: {ID: 0x0035, type: DataType.UINT8, default: 255, minInclusive: 0, maxExclusiveRef: "occupiedSetbackMax"},
            occupiedSetbackMax: {ID: 0x0036, type: DataType.UINT8, default: 255, maxInclusive: 255, minExclusiveRef: "occupiedSetbackMin"},
            unoccupiedSetback: {
                ID: 0x0037,
                type: DataType.UINT8,
                writable: true,
                default: 255,
                minInclusiveRef: "unoccupiedSetbackMin",
                maxInclusiveRef: "unoccupiedSetbackMax",
            },
            unoccupiedSetbackMin: {ID: 0x0038, type: DataType.UINT8, default: 255, minInclusive: 0, maxExclusiveRef: "unoccupiedSetbackMax"},
            unoccupiedSetbackMax: {ID: 0x0039, type: DataType.UINT8, default: 255, maxInclusive: 255, minExclusiveRef: "unoccupiedSetbackMin"},
        ...
        commands: {
            ...
            setWeeklySchedule: {
                ID: 0x01,
                parameters: [
                    {name: "numoftrans", type: DataType.UINT8, minInclusive: 0, maxInclusive: 10},
    ...
    hvacDehumidificationCtrl: {
        ...
        attributes: {
            ...
            dehumidCooling: {ID: 0x0001, type: DataType.UINT8, reportRequired: true, required: true, maxInclusiveRef: "dehumidMaxCool"},
    ...
    lightingColorCtrl: {
        ...
        attributes: {
            ...
            compensationText: {ID: 0x0006, type: DataType.CHAR_STR, maxLength: 254},
            colorTemperature: {
                ID: 0x0007,
                type: DataType.UINT16,
                reportRequired: true,
                ...
                max: 65279,
                default: 250,
                minInclusiveRef: "colorTempPhysicalMin",
                maxInclusiveRef: "colorTempPhysicalMax",
            ...
            colorTempPhysicalMin: {ID: 0x400b, type: DataType.UINT16, max: 65279, default: 0, maxInclusiveRef: "colorTempPhysicalMax"},
            colorTempPhysicalMax: {ID: 0x400c, type: DataType.UINT16, max: 65279, default: 65279, minInclusiveRef: "colorTempPhysicalMin"},
            coupleColorTempToLevelMin: {
                ID: 0x400d,
                type: DataType.UINT16,
                minInclusiveRef: "colorTempPhysicalMin",
                maxInclusiveRef: "colorTemperature",
            },
    ...
    lightingBallastCfg: {
        ...
        attributes: {
            ...
            minLevel: {
                ...
                minInclusiveRef: "physicalMinLevel",
                maxInclusiveRef: "maxLevel",
            },
            maxLevel: {
                ID: 0x0011,
                ...
                minInclusiveRef: "minLevel",
                maxInclusiveRef: "physicalMaxLevel",
            },
            ...
            lampType: {ID: 0x0030, type: DataType.CHAR_STR, writable: true, default: "", maxLength: 16},
            lampManufacturer: {ID: 0x0031, type: DataType.CHAR_STR, writable: true, default: "", maxLength: 16},
    ...
    msIlluminanceMeasurement: {
        ...
        attributes: {
            ...
            minMeasuredValue: {ID: 0x0001, type: DataType.UINT16, required: true, min: 1, max: 65533, maxExclusiveRef: "maxMeasuredValue"},
            maxMeasuredValue: {ID: 0x0002, type: DataType.UINT16, required: true, min: 2, max: 65534, minExclusiveRef: "minMeasuredValue"},
    ...
    msTemperatureMeasurement: {
        ...
        attributes: {
            measuredValue: {
                ...
                required: true,
                default: -32768,
                minInclusiveRef: "minMeasuredValue",
                maxInclusiveRef: "maxMeasuredValue",
            },
            minMeasuredValue: {
                ID: 0x0001,
                type: DataType.INT16,
                ...
                max: 32766,
                default: -32768,
                maxExclusiveRef: "maxMeasuredValue",
            },
            maxMeasuredValue: {
                ID: 0x0002,
                type: DataType.INT16,
                ...
                max: 32767,
                default: -32768,
                minExclusiveRef: "minMeasuredValue",
            },
            tolerance: {ID: 0x0003, type: DataType.UINT16, max: 2048},
    ...
    msPressureMeasurement: {
        ...
        attributes: {
            ...
            tolerance: {ID: 0x0003, type: DataType.UINT16, max: 2048},
            scaledValue: {ID: 0x0010, type: DataType.INT16, default: 0, minInclusiveRef: "minScaledValue", maxInclusiveRef: "maxScaledValue"},
            minScaledValue: {ID: 0x0011, type: DataType.INT16, min: -32767, max: 32766, default: -32768, maxExclusiveRef: "maxScaledValue"},
            maxScaledValue: {ID: 0x0012, type: DataType.INT16, min: -32766, max: 32767, default: -32768, minExclusiveRef: "minScaledValue"},
    ...
    msFlowMeasurement: {
        ...
        attributes: {
            ...
            minMeasuredValue: {ID: 0x0001, type: DataType.UINT16, required: true, max: 65533, default: 65535, maxExclusiveRef: "maxMeasuredValue"},
            maxMeasuredValue: {
                ID: 0x0002,
                type: DataType.UINT16,
                required: true,
    ...
    msRelativeHumidity: {
        ...
        attributes: {
            ...
            minMeasuredValue: {ID: 0x0001, type: DataType.UINT16, required: true, max: 9999, default: 65535, maxExclusiveRef: "maxMeasuredValue"},
            maxMeasuredValue: {
                ID: 0x0002,
                type: DataType.UINT16,
                required: true,
    ...
    pHMeasurement: {
        ...
        attributes: {
            ...
            minMeasuredValue: {ID: 0x0001, type: DataType.UINT16, required: true, default: 65535, maxExclusiveRef: "maxMeasuredValue"},
            maxMeasuredValue: {ID: 0x0002, type: DataType.UINT16, required: true, max: 1400, default: 65535, minExclusiveRef: "minMeasuredValue"},
    ...
    msElectricalConductivity: {
        ...
        attributes: {
            ...
            minMeasuredValue: {ID: 0x0001, type: DataType.UINT16, required: true, default: 65535, maxExclusiveRef: "maxMeasuredValue"},
            maxMeasuredValue: {ID: 0x0002, type: DataType.UINT16, required: true, max: 65534, default: 65535, minExclusiveRef: "minMeasuredValue"},
    ...
    msCarbonMonoxide: {
        ...
        attributes: {
            ...
            minMeasuredValue: {ID: 0x0001, type: DataType.SINGLE_PREC, required: true, min: 0, maxExclusiveRef: "maxMeasuredValue"},
            maxMeasuredValue: {ID: 0x0002, type: DataType.SINGLE_PREC, required: true, max: 1, minExclusiveRef: "minMeasuredValue"},
        ...
        commands: {
            startWarning: {
                ...
                parameters: [
                    ...
                    {name: "strobedutycycle", type: DataType.UINT8, maxInclusive: 100},
    ...
    touchlink: {
        ...
        commands: {
            ...
            networkStart: {
                ...
                parameters: [
                    ...
                    {name: "nwkAddr", type: DataType.UINT16, minInclusive: 1, maxInclusive: 65527},
        ...
        commandsResponse: {
            scanResponse: {
                ...
                parameters: [
                    {name: "transactionID", type: DataType.UINT32},
                    {name: "rssiCorrection", type: DataType.UINT8, minInclusive: 0, maxInclusive: 20},
            ...
            deviceInformation: {
                ...
                parameters: [
                    ...
                    {name: "deviceInformationRecordList", type: BuffaloZclDataType.BUFFER, minLength: 0, maxLength: 5},
                ],
                required: true,
            },
            networkStart: {
