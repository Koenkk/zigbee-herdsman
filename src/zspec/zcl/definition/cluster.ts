...
export const Clusters: Readonly<Record<ClusterName, Readonly<ClusterDefinition>>> = {
    ...
    genOnOff: {
        ...
        attributes: {
            ...
            // custom
            nodonTransitionTime: {ID: 0x0001, type: DataType.UINT16, manufacturerCode: ManufacturerCode.NODON, writable: true, max: 0xffff},
            tuyaBacklightSwitch: {ID: 0x5000, type: DataType.ENUM8, writable: true, max: 0xff},
            tuyaBacklightMode: {ID: 0x8001, type: DataType.ENUM8, writable: true, max: 0xff},
            moesStartUpOnOff: {ID: 0x8002, type: DataType.ENUM8, writable: true, max: 0xff},
            tuyaOperationMode: {ID: 0x8004, type: DataType.ENUM8, writable: true, max: 0xff},
            elkoPreWarningTime: {ID: 0xe000, type: DataType.UINT16, manufacturerCode: ManufacturerCode.ADEO, writable: true, max: 0xffff},
            elkoOnTimeReload: {ID: 0xe001, type: DataType.UINT32, manufacturerCode: ManufacturerCode.ADEO, writable: true, max: 0xffffffff},
            elkoOnTimeReloadOptions: {ID: 0xe002, type: DataType.BITMAP8, manufacturerCode: ManufacturerCode.ADEO, writable: true},
        },
        commands: {
    ...
    genLevelCtrl: {
        ...
        attributes: {
            ...
            // custom
            // TODO: needed?
            elkoStartUpCurrentLevel: {ID: 0x4000, type: DataType.UINT8, manufacturerCode: ManufacturerCode.ADEO, writable: true, max: 0xff},
        },
        commands: {
            moveToLevel: {
                ID: 0x00,
    ...
    piPartition: {
        ...
        attributes: {
            ...
            partionedFrameSize: {ID: 0x0002, type: DataType.UINT8, required: true, writable: true, max: 0xff, default: 0x50},
            largeFrameSize: {ID: 0x0003, type: DataType.UINT16, required: true, writable: true, max: 0xffff, default: 0x0500},
            numberOfAckFrame: {ID: 0x0004, type: DataType.UINT8, required: true, writable: true, max: 0xff, default: 100},
            nackTimeout: {ID: 0x0005, type: DataType.UINT16, required: true, max: 0xffff},
            interframeDelay: {ID: 0x0006, type: DataType.UINT8, required: true, writable: true, max: 0xff},
    ...
    closuresShadeCfg: {
        ...
        attributes: {
            ...
            losedLimit: {ID: 0x0010, type: DataType.UINT16, writable: true, required: true, min: 1, max: 0xfffe, default: 1},
            mode: {ID: 0x0011, type: DataType.ENUM8, writable: true, required: true, max: 0xfe, default: 0},
        },
        commands: {},
        commandsResponse: {},
    },
    closuresDoorLock: {
        ...
        attributes: {
            ...
            operatingMode: {ID: 0x0025, type: DataType.ENUM8, writable: true, writeOptional: true, reportRequired: true, default: 0},
            ...
            zigbeeSecurityLevel: {ID: 0x0034, type: DataType.ENUM8, reportRequired: true, default: 0},
    ...
    closuresWindowCovering: {
        ...
        attributes: {
            ...
            velocityLift: {ID: 0x0014, type: DataType.UINT16, writable: true, max: 0xffff, default: 0},
            accelerationTimeLift: {ID: 0x0015, type: DataType.UINT16, writable: true, max: 0xffff, default: 0},
            decelerationTimeLift: {ID: 0x0016, type: DataType.UINT16, writable: true, max: 0xffff, default: 0},
            ...
            elkoDriveCloseDuration: {ID: 0xe000, type: DataType.UINT16, manufacturerCode: ManufacturerCode.ADEO, writable: true, max: 0xffff},
            elkoProtectionStatus: {ID: 0xe010, type: DataType.BITMAP8, manufacturerCode: ManufacturerCode.ADEO, writable: true},
            ...
            elkoProtectionSensor: {ID: 0xe013, type: DataType.BITMAP8, manufacturerCode: ManufacturerCode.ADEO, writable: true},
            elkoLiftDriveUpTime: {ID: 0xe014, type: DataType.UINT16, manufacturerCode: ManufacturerCode.ADEO, writable: true, max: 0xffff},
            elkoLiftDriveDownTime: {ID: 0xe015, type: DataType.UINT16, manufacturerCode: ManufacturerCode.ADEO, writable: true, max: 0xffff},
            elkoTiltOpenCloseAndStepTime: {ID: 0xe016, type: DataType.UINT16, manufacturerCode: ManufacturerCode.ADEO, writable: true, max: 0xffff},
            ...
            tuyaMovingState: {ID: 0xf000, type: DataType.ENUM8, writable: true, max: 0xff},
            tuyaCalibration: {ID: 0xf001, type: DataType.ENUM8, writable: true, max: 0xff},
            stepPositionLift: {ID: 0xf001, type: DataType.ENUM8, manufacturerCode: ManufacturerCode.LEGRAND_GROUP, writable: true, max: 0xff},
            tuyaMotorReversal: {ID: 0xf002, type: DataType.ENUM8, writable: true, max: 0xff},
            calibrationMode: {ID: 0xf002, type: DataType.ENUM8, manufacturerCode: ManufacturerCode.LEGRAND_GROUP, writable: true, max: 0xff},
            moesCalibrationTime: {ID: 0xf003, type: DataType.UINT16, writable: true, max: 0xffff},
            ...
            stepPositionTilt: {ID: 0xf004, type: DataType.ENUM8, manufacturerCode: ManufacturerCode.LEGRAND_GROUP, writable: true, max: 0xff},
            nikoCalibrationTimeUp: {ID: 0xfcc1, type: DataType.UINT16, manufacturerCode: ManufacturerCode.NIKO_NV, writable: true, max: 0xffff},
            nikoCalibrationTimeDown: {ID: 0xfcc2, type: DataType.UINT16, manufacturerCode: ManufacturerCode.NIKO_NV, writable: true, max: 0xffff},
        },
        commands: {
    ...
    barrierControl: {
        ...
        attributes: {
            ...
            openEvents: {ID: 0x0004, type: DataType.UINT16, writable: true, max: 0xfffe, default: 0},
            closeEvents: {ID: 0x0005, type: DataType.UINT16, writable: true, max: 0xfffe, default: 0},
            commandOpenEvents: {ID: 0x0006, type: DataType.UINT16, writable: true, max: 0xfffe, default: 0},
            commandCloseEvents: {ID: 0x0007, type: DataType.UINT16, writable: true, max: 0xfffe, default: 0},
            openPeriod: {ID: 0x0008, type: DataType.UINT16, writable: true, max: 0xfffe},
            closePeriod: {ID: 0x0009, type: DataType.UINT16, writable: true, max: 0xfffe},
            barrierPosition: {
                ID: 0x000a,
                type: DataType.UINT8,
                reportRequired: true,
    ...
    hvacPumpCfgCtrl: {
        ...
        attributes: {
            ...
            pumpStatus: {ID: 0x0010, type: DataType.BITMAP16, reportRequired: true},
            ...
            capacity: {ID: 0x0013, type: DataType.INT16, reportRequired: true, required: true, min: 0, max: 0x7fff},
            speed: {ID: 0x0014, type: DataType.UINT16, max: 0xfffe},
            lifetimeRunningHours: {ID: 0x0015, type: DataType.UINT24, writable: true, max: 0xfffffe, default: 0},
            power: {ID: 0x0016, type: DataType.UINT24, writable: true, max: 0xfffffe},
            lifetimeEnergyConsumed: {ID: 0x0017, type: DataType.UINT32, max: 0xfffffffe, default: 0},

            operationMode: {ID: 0x0020, type: DataType.ENUM8, writable: true, required: true, max: 0xfe, default: 0},
            controlMode: {ID: 0x0021, type: DataType.ENUM8, writable: true, max: 0xfe, default: 0},
    ...
    hvacThermostat: {
        ...
        attributes: {
            ...
            systemTypeConfig: {ID: 0x0009, type: DataType.BITMAP8, writable: true, writeOptional: true, default: 0},
            ...
            minSetpointDeadBand: {ID: 0x0019, type: DataType.INT8, writable: true, writeOptional: true, min: 10, max: 25, default: 25},
            ...
            tempSetpointHoldDuration: {ID: 0x0024, type: DataType.UINT16, writable: true, min: 0, max: 1440},
            ...
            occupiedSetbackMin: {ID: 0x0035, type: DataType.UINT8, min: 0, maxExclRef: "occupiedSetbackMax"},
            occupiedSetbackMax: {ID: 0x0036, type: DataType.UINT8, minExclRef: "occupiedSetbackMin"},
            unoccupiedSetback: {
                ID: 0x0037,
                type: DataType.UINT8,
                writable: true,
            ...
            unoccupiedSetbackMin: {ID: 0x0038, type: DataType.UINT8, min: 0, maxExclRef: "unoccupiedSetbackMax"},
            unoccupiedSetbackMax: {ID: 0x0039, type: DataType.UINT8, minExclRef: "unoccupiedSetbackMin"},
            emergencyHeatDelta: {ID: 0x003a, type: DataType.UINT8, writable: true},

            acType: {ID: 0x0040, type: DataType.ENUM8, writable: true, default: 0},
            acCapacity: {ID: 0x0041, type: DataType.UINT16, writable: true, max: 0xffff, default: 0},
            ...
            acErrorCode: {ID: 0x0044, type: DataType.BITMAP32, writable: true, max: 0xffffffff, default: 0},
            ...
            SinopeOccupancy: {ID: 0x0400, type: DataType.ENUM8, manufacturerCode: ManufacturerCode.SINOPE_TECHNOLOGIES, writable: true, max: 0xff},
            elkoLoad: {ID: 0x0401, type: DataType.UINT16, writable: true, max: 0xffff},
            ...
            elkoDisplayText: {ID: 0x0402, type: DataType.CHAR_STR, writable: true},
            SinopeBacklight: {ID: 0x0402, type: DataType.ENUM8, manufacturerCode: ManufacturerCode.SINOPE_TECHNOLOGIES, writable: true, max: 0xff},
            elkoSensor: {ID: 0x0403, type: DataType.ENUM8, writable: true, max: 0xff},
            elkoRegulatorTime: {ID: 0x0404, type: DataType.UINT8, writable: true, max: 0xff},
            ...
            elkoRegulatorMode: {ID: 0x0405, type: DataType.BOOLEAN, writable: true},
            elkoPowerStatus: {ID: 0x0406, type: DataType.BOOLEAN, writable: true},
            elkoDateTime: {ID: 0x0407, type: DataType.OCTET_STR, writable: true},
            elkoMeanPower: {ID: 0x0408, type: DataType.UINT16, writable: true, max: 0xffff},
            elkoExternalTemp: {ID: 0x0409, type: DataType.INT16, writable: true, min: -32768, max: 32767},
            elkoNightSwitching: {ID: 0x0411, type: DataType.BOOLEAN, writable: true},
            elkoFrostGuard: {ID: 0x0412, type: DataType.BOOLEAN, writable: true},
            elkoChildLock: {ID: 0x0413, type: DataType.BOOLEAN, writable: true},
            elkoMaxFloorTemp: {ID: 0x0414, type: DataType.UINT8, writable: true, max: 0xff},
            elkoRelayState: {ID: 0x0415, type: DataType.BOOLEAN, writable: true},
            elkoVersion: {ID: 0x0416, type: DataType.OCTET_STR, writable: true},
            elkoCalibration: {ID: 0x0417, type: DataType.INT8, writable: true, min: -128, max: 127},
            elkoLastMessageId: {ID: 0x0418, type: DataType.UINT8, writable: true, max: 0xff},
            elkoLastMessageStatus: {ID: 0x0419, type: DataType.UINT8, writable: true, max: 0xff},
            ...
            danfossWindowOpenInternal: {ID: 0x4000, type: DataType.ENUM8, manufacturerCode: ManufacturerCode.DANFOSS_A_S, writable: true, max: 0xff},
            StelproOutdoorTemp: {ID: 0x4001, type: DataType.INT16, writable: true, min: -32768, max: 32767},
            ...
            danfossWindowOpenExternal: {ID: 0x4003, type: DataType.BOOLEAN, manufacturerCode: ManufacturerCode.DANFOSS_A_S, writable: true},
            danfossDayOfWeek: {ID: 0x4010, type: DataType.ENUM8, manufacturerCode: ManufacturerCode.DANFOSS_A_S, writable: true, max: 0xff},
            danfossTriggerTime: {ID: 0x4011, type: DataType.UINT16, manufacturerCode: ManufacturerCode.DANFOSS_A_S, writable: true, max: 0xffff},
            viessmannAssemblyMode: {ID: 0x4012, type: DataType.BOOLEAN, manufacturerCode: ManufacturerCode.VIESSMANN_ELEKTRONIK_GMBH, writable: true},
            danfossMountedModeActive: {ID: 0x4012, type: DataType.BOOLEAN, manufacturerCode: ManufacturerCode.DANFOSS_A_S, writable: true},
            danfossMountedModeControl: {ID: 0x4013, type: DataType.BOOLEAN, manufacturerCode: ManufacturerCode.DANFOSS_A_S, writable: true},
            danfossThermostatOrientation: {ID: 0x4014, type: DataType.BOOLEAN, manufacturerCode: ManufacturerCode.DANFOSS_A_S, writable: true},
            ...
            danfossRadiatorCovered: {ID: 0x4016, type: DataType.BOOLEAN, manufacturerCode: ManufacturerCode.DANFOSS_A_S, writable: true},
            StelproSystemMode: {ID: 0x401c, type: DataType.ENUM8, writable: true, max: 0xff},
            ...
            danfossHeatAvailable: {ID: 0x4030, type: DataType.BOOLEAN, manufacturerCode: ManufacturerCode.DANFOSS_A_S, writable: true},
            danfossHeatRequired: {ID: 0x4031, type: DataType.BOOLEAN, manufacturerCode: ManufacturerCode.DANFOSS_A_S, writable: true},
            danfossLoadBalancingEnable: {ID: 0x4032, type: DataType.BOOLEAN, manufacturerCode: ManufacturerCode.DANFOSS_A_S, writable: true},
            danfossLoadRoomMean: {
                ID: 0x4040,
                type: DataType.INT16,
                manufacturerCode: ManufacturerCode.DANFOSS_A_S,
            ...
            danfossAdaptionRunControl: {ID: 0x404c, type: DataType.ENUM8, manufacturerCode: ManufacturerCode.DANFOSS_A_S, writable: true, max: 0xff},
            danfossAdaptionRunStatus: {ID: 0x404d, type: DataType.BITMAP8, manufacturerCode: ManufacturerCode.DANFOSS_A_S, writable: true},
            danfossAdaptionRunSettings: {ID: 0x404e, type: DataType.BITMAP8, manufacturerCode: ManufacturerCode.DANFOSS_A_S, writable: true},
            danfossPreheatStatus: {ID: 0x404f, type: DataType.BOOLEAN, manufacturerCode: ManufacturerCode.DANFOSS_A_S, writable: true},
            danfossPreheatTime: {ID: 0x4050, type: DataType.UINT32, manufacturerCode: ManufacturerCode.DANFOSS_A_S, writable: true},
            danfossWindowOpenFeatureEnable: {ID: 0x4051, type: DataType.BOOLEAN, manufacturerCode: ManufacturerCode.DANFOSS_A_S, writable: true},
            danfossRoomStatusCode: {ID: 0x4100, type: DataType.BITMAP16, manufacturerCode: ManufacturerCode.DANFOSS_A_S, writable: true},
            danfossOutputStatus: {ID: 0x4110, type: DataType.ENUM8, manufacturerCode: ManufacturerCode.DANFOSS_A_S, writable: true, max: 0xff},
            danfossRoomFloorSensorMode: {ID: 0x4120, type: DataType.ENUM8, manufacturerCode: ManufacturerCode.DANFOSS_A_S, writable: true, max: 0xff},
            ...
            danfossScheduleTypeUsed: {ID: 0x4130, type: DataType.ENUM8, manufacturerCode: ManufacturerCode.DANFOSS_A_S, writable: true, max: 0xff},
            danfossIcon2PreHeat: {ID: 0x4131, type: DataType.ENUM8, manufacturerCode: ManufacturerCode.DANFOSS_A_S, writable: true, max: 0xff},
            danfossIcon2PreHeatStatus: {ID: 0x414f, type: DataType.ENUM8, manufacturerCode: ManufacturerCode.DANFOSS_A_S, writable: true, max: 0xff},
    ...
    hvacFanCtrl: {
        ID: 0x0202,
        attributes: {
            fanMode: {ID: 0x0000, type: DataType.ENUM8, writable: true, required: true, max: 0x06, default: 5},
            fanModeSequence: {ID: 0x0001, type: DataType.ENUM8, writable: true, required: true, max: 0x04, default: 2},
        },
        commands: {},
        commandsResponse: {},
    },
    hvacDehumidificationCtrl: {
        ...
        attributes: {
            ...
            relativeHumidDisplay: {ID: 0x0015, type: DataType.ENUM8, writable: true, max: 0x01, default: 0},
        },
        commands: {},
        commandsResponse: {},
    },
    hvacUserInterfaceCfg: {
        ID: 0x0204,
        attributes: {
            tempDisplayMode: {ID: 0x0000, type: DataType.ENUM8, writable: true, required: true, max: 0x01, default: 0},
            keypadLockout: {ID: 0x0001, type: DataType.ENUM8, writable: true, required: true, max: 0x05, default: 0},
            programmingVisibility: {ID: 0x0002, type: DataType.ENUM8, writable: true, max: 0x01, default: 0},
            // custom
            danfossViewingDirection: {ID: 0x4000, type: DataType.ENUM8, manufacturerCode: ManufacturerCode.DANFOSS_A_S, writable: true, max: 0xff},
        },
        commands: {},
        commandsResponse: {},
    },
    lightingColorCtrl: {
        ...
        attributes: {
            ...
            // custom
            tuyaRgbMode: {ID: 0xf000, type: DataType.UINT8, writable: true, max: 0xff},
            tuyaBrightness: {ID: 0xf001, type: DataType.UINT8, writable: true, max: 0xff},
        },
        commands: {
            moveToHue: {
                ID: 0x00,
    ...
    lightingBallastCfg: {
        ...
        attributes: {
            ...
            // custom
            elkoControlMode: {ID: 0xe000, type: DataType.ENUM8, manufacturerCode: ManufacturerCode.ADEO, writable: true, max: 0xff},
            wiserControlMode: {ID: 0xe000, type: DataType.ENUM8, manufacturerCode: ManufacturerCode.SCHNEIDER_ELECTRIC, writable: true, max: 0xff},
        },
        commands: {},
        commandsResponse: {},
    },
    ...
    msIlluminanceLevelSensing: {
        ID: 0x0401,
        attributes: {
            levelStatus: {ID: 0x0000, type: DataType.ENUM8, reportRequired: true, required: true, max: 254},
    ...
    msTemperatureMeasurement: {
        ...
        attributes: {
            ...
            minMeasuredValue: {ID: 0x0001, type: DataType.INT16, required: true, min: -27315, max: 32766, maxExclRef: "maxMeasuredValue"},
            maxMeasuredValue: {ID: 0x0002, type: DataType.INT16, required: true, min: -27314, max: 32767, minExclRef: "minMeasuredValue"},
            tolerance: {ID: 0x0003, type: DataType.UINT16, max: 0x0800},
            // custom
            minPercentChange: {ID: 0x0010, type: DataType.UNKNOWN, writable: true},
            minAbsoluteChange: {ID: 0x0011, type: DataType.UNKNOWN, writable: true},
    ...
    msPressureMeasurement: {
        ...
        attributes: {
            ...
            minMeasuredValue: {ID: 0x0001, type: DataType.INT16, required: true, min: -32767, max: 32766, maxExclRef: "maxMeasuredValue"},
            maxMeasuredValue: {ID: 0x0002, type: DataType.INT16, required: true, min: -32766, max: 32767, minExclRef: "minMeasuredValue"},
            tolerance: {ID: 0x0003, type: DataType.UINT16, max: 0x0800},
            // if supported, should also be `reportRequired: true`
            scaledValue: {ID: 0x0010, type: DataType.INT16, default: 0, minRef: "minScaledValue", maxRef: "maxScaledValue"},
            minScaledValue: {ID: 0x0011, type: DataType.INT16, min: -32767, max: 32766, maxExclRef: "maxScaledValue"},
            maxScaledValue: {ID: 0x0012, type: DataType.INT16, min: -32766, max: 32767, minExclRef: "minScaledValue"},
            // if supported, should also be `reportRequired: true`
    ...
    msFlowMeasurement: {
        ...
        attributes: {
            ...
            minMeasuredValue: {ID: 0x0001, type: DataType.UINT16, required: true, max: 65533, maxExclRef: "maxMeasuredValue"},
            maxMeasuredValue: {ID: 0x0002, type: DataType.UINT16, required: true, min: 1, max: 65534, minExclRef: "minMeasuredValue"},
            tolerance: {ID: 0x0003, type: DataType.UINT16, max: 0x0800},
        },
        commands: {},
        commandsResponse: {},
    ...
    msRelativeHumidity: {
        ...
        attributes: {
            ...
            minMeasuredValue: {ID: 0x0001, type: DataType.UINT16, required: true, max: 9999, maxExclRef: "maxMeasuredValue"},
            maxMeasuredValue: {ID: 0x0002, type: DataType.UINT16, required: true, min: 1, max: 10000, minExclRef: "minMeasuredValue"},
            tolerance: {ID: 0x0003, type: DataType.UINT16, max: 0x0800},
            // custom
            sprutHeater: {ID: 0x6600, type: DataType.BOOLEAN, manufacturerCode: ManufacturerCode.CUSTOM_SPRUT_DEVICE, writable: true},
        },
        commands: {},
        commandsResponse: {},
    },
    msOccupancySensing: {
        ...
        attributes: {
            ...
            pirOToUDelay: {ID: 0x0010, type: DataType.UINT16, writable: true, max: 0xfffe, default: 0x0000},
            pirUToODelay: {ID: 0x0011, type: DataType.UINT16, writable: true, max: 0xfffe, default: 0x0000},
            pirUToOThreshold: {ID: 0x0012, type: DataType.UINT8, writable: true, min: 0x01, max: 0xfe, default: 0x01},
            ultrasonicOToUDelay: {ID: 0x0020, type: DataType.UINT16, writable: true, max: 0xfffe, default: 0x0000},
            ultrasonicUToODelay: {ID: 0x0021, type: DataType.UINT16, writable: true, max: 0xfffe, default: 0x0000},
            ultrasonicUToOThreshold: {ID: 0x0022, type: DataType.UINT8, writable: true, min: 0x01, max: 0xfe, default: 0x01},
            contactOToUDelay: {ID: 0x0030, type: DataType.UINT16, writable: true, max: 0xfffe, default: 0x0000},
            contactUToODelay: {ID: 0x0031, type: DataType.UINT16, writable: true, max: 0xfffe, default: 0x0000},
            contactUToOThreshold: {ID: 0x0032, type: DataType.UINT8, writable: true, min: 0x01, max: 0xfe, default: 0x01},
            // custom
            sprutOccupancyLevel: {
                ID: 0x6600,
                type: DataType.UINT16,
            ...
            elkoOccupancyDfltOperationMode: {ID: 0xe000, type: DataType.ENUM8, manufacturerCode: ManufacturerCode.ADEO, writable: true, max: 0xff},
            elkoOccupancyOperationMode: {ID: 0xe001, type: DataType.ENUM8, manufacturerCode: ManufacturerCode.ADEO, writable: true, max: 0xff},
            elkoForceOffTimeout: {ID: 0xe002, type: DataType.UINT16, manufacturerCode: ManufacturerCode.ADEO, writable: true, max: 0xffff},
            elkoOccupancySensitivity: {ID: 0xe003, type: DataType.UINT8, manufacturerCode: ManufacturerCode.ADEO, writable: true, max: 0xff},
        },
        commands: {},
        commandsResponse: {},
    },
    ...
    pHMeasurement: {
        ...
        attributes: {
            ...
            minMeasuredValue: {ID: 0x0001, type: DataType.UINT16, required: true, max: 1399, maxExclRef: "maxMeasuredValue"},
            maxMeasuredValue: {ID: 0x0002, type: DataType.UINT16, required: true, min: 1, max: 1400, minExclRef: "minMeasuredValue"},
    ...
    msCO2: {
        ...
        attributes: {
            ...
            tolerance: {ID: 0x0003, type: DataType.SINGLE_PREC},
            // custom
            sprutCO2Calibration: {ID: 0x6600, type: DataType.BOOLEAN, manufacturerCode: ManufacturerCode.CUSTOM_SPRUT_DEVICE, writable: true},
            sprutCO2AutoCalibration: {ID: 0x6601, type: DataType.BOOLEAN, manufacturerCode: ManufacturerCode.CUSTOM_SPRUT_DEVICE, writable: true},
        },
        commands: {},
        commandsResponse: {},
    },
    ...
    ssIasZone: {
        ...
        attributes: {
            ...
            // custom
            develcoAlarmOffDelay: {ID: 0x8001, type: DataType.UINT16, manufacturerCode: ManufacturerCode.DEVELCO, writable: true, max: 0xffff},
        },
        commands: {
            enrollRsp: {
                ID: 0x00,
    ...
    piAnalogInputReg: {
        ID: 0x0602,
        attributes: {
            covIncrement: {ID: 0x0016, type: DataType.SINGLE_PREC, writable: true, writeOptional: true},
            ...
            updateInterval: {ID: 0x0076, type: DataType.UINT8, writable: true, writeOptional: true},
            profileName: {ID: 0x00a8, type: DataType.CHAR_STR, writable: true, writeOptional: true, default: "\u0000"},
        },
        commands: {},
        commandsResponse: {},
    },
    piAnalogInputExt: {
        ID: 0x0603,
        attributes: {
            ackedTransitions: {ID: 0x0000, type: DataType.BITMAP8, required: true, writable: true, writeOptional: true, default: 0},
            notificationClass: {ID: 0x0011, type: DataType.UINT16, required: true, writable: true, writeOptional: true, max: 0xffff, default: 0},
            deadband: {ID: 0x0019, type: DataType.SINGLE_PREC, required: true, writable: true, writeOptional: true, default: 0},
            eventEnable: {ID: 0x0023, type: DataType.BITMAP8, required: true, writable: true, writeOptional: true, default: 0},
            eventState: {ID: 0x0024, type: DataType.ENUM8, default: 0},
            highLimit: {ID: 0x002d, type: DataType.SINGLE_PREC, required: true, writable: true, writeOptional: true, default: 0},
            limitEnable: {ID: 0x0034, type: DataType.BITMAP8, required: true, writable: true, writeOptional: true, max: 0x11, default: 0},
    ...
    piAnalogOutputReg: {
        ID: 0x0604,
        attributes: {
            covIncrement: {ID: 0x0016, type: DataType.SINGLE_PREC, writable: true, writeOptional: true, default: 0},
            deviceType: {ID: 0x001f, type: DataType.CHAR_STR, default: "\u0000"},
            objectId: {ID: 0x004b, type: DataType.BAC_OID, required: true, max: 0xffffffff},
            objectName: {ID: 0x004d, type: DataType.CHAR_STR, required: true, default: "\u0000"},
            objectType: {ID: 0x004f, type: DataType.ENUM16, required: true},
    ...
    piBinaryInputReg: {
        ID: 0x0608,
        attributes: {
            changeOfStateCount: {ID: 0x000f, type: DataType.UINT32, writable: true, writeOptional: true, default: 0xffffffff},
            changeOfStateTime: {ID: 0x0010, type: DataType.STRUCT /* default: (0xffffffff, 0xffffffff) */},
            deviceType: {ID: 0x001f, type: DataType.CHAR_STR, default: "\u0000"},
            elapsedActiveTime: {ID: 0x0021, type: DataType.UINT32, writable: true, writeOptional: true, default: 0xffffffff},
    ...
    piBinaryInputExt: {
        ...
        attributes: {
            ackedTransitions: {ID: 0x0000, type: DataType.BITMAP8, required: true, writable: true, writeOptional: true, default: 0},
            alarmValue: {ID: 0x0006, type: DataType.BOOLEAN, required: true, writable: true, writeOptional: true},
            notificationClass: {ID: 0x0011, type: DataType.UINT16, required: true, writable: true, writeOptional: true, default: 0},
            eventEnable: {ID: 0x0023, type: DataType.BITMAP8, required: true, writable: true, writeOptional: true, default: 0},
    ...
    piMultistateInputExt: {
        ...
        attributes: {
            ackedTransitions: {ID: 0x0000, type: DataType.BITMAP8, required: true, writable: true, writeOptional: true, default: 0},
            alarmValues: {ID: 0x0006, type: DataType.SET, required: true, writable: true, writeOptional: true, max: 0xffff},
            notificationClass: {ID: 0x0011, type: DataType.UINT16, required: true, writable: true, writeOptional: true, default: 0},
            eventEnable: {ID: 0x0023, type: DataType.BITMAP8, required: true, writable: true, writeOptional: true, default: 0},
            eventState: {ID: 0x0024, type: DataType.ENUM8, default: 0},
            faultValues: {ID: 0x0025, type: DataType.SET, required: true, writable: true, writeOptional: true, max: 0xffff, default: 0},
            notifyType: {ID: 0x0048, type: DataType.ENUM8, required: true, writable: true, writeOptional: true, default: 0},
            timeDelay: {ID: 0x0071, type: DataType.UINT8, required: true, writable: true, writeOptional: true, default: 0},
            // each index is any of: UINT16 | TOD | struct(DATE, TOD)
            eventTimeStamps: {ID: 0x0082, type: DataType.ARRAY, required: true},
    ...
    piMultistateOutputReg: {
        ...
        attributes: {
            deviceType: {ID: 0x001f, type: DataType.CHAR_STR, default: "\u0000"},
            feedBackValue: {ID: 0x0028, type: DataType.ENUM8, writable: true, writeOptional: true, max: 1},
            objectIdentifier: {ID: 0x004b, type: DataType.BAC_OID, required: true, max: 0xffffffff},
            objectName: {ID: 0x004d, type: DataType.CHAR_STR, required: true, default: "\u0000"},
            objectType: {ID: 0x004f, type: DataType.ENUM16, required: true},
            profileName: {ID: 0x00a8, type: DataType.CHAR_STR, default: "\u0000"},
    ...
    seMetering: {
        ...
        attributes: {
            ...
            // custom
            develcoPulseConfiguration: {ID: 0x0300, type: DataType.UINT16, manufacturerCode: ManufacturerCode.DEVELCO, writable: true, max: 0xffff},
            ...
            develcoInterfaceMode: {ID: 0x0302, type: DataType.ENUM16, manufacturerCode: ManufacturerCode.DEVELCO, writable: true, max: 0xffff},
            owonL1PhasePower: {
                ID: 0x2000,
                type: DataType.INT24,
            ...
            owonFrequency: {ID: 0x5005, type: DataType.UINT8, manufacturerCode: ManufacturerCode.OWON_TECHNOLOGY_INC, writable: true, max: 0xff},
            owonReportMap: {ID: 0x1000, type: DataType.BITMAP8, manufacturerCode: ManufacturerCode.OWON_TECHNOLOGY_INC, writable: true},
            ...
            owonReportMode: {ID: 0x5007, type: DataType.UINT8, manufacturerCode: ManufacturerCode.OWON_TECHNOLOGY_INC, writable: true, max: 0xff},
    ...
    haElectricalMeasurement: {
        ...
        attributes: {
            ...
            dcVoltage: {ID: 0x0100, type: DataType.INT16, reportRequired: true, min: -32767},
            dcVoltageMin: {ID: 0x0101, type: DataType.INT16, min: -32767},
            dcvoltagemax: {ID: 0x0102, type: DataType.INT16, min: -32767},
            dcCurrent: {ID: 0x0103, type: DataType.INT16, reportRequired: true, min: -32767},
            dcCurrentMin: {ID: 0x0104, type: DataType.INT16, min: -32767},
            dcCurrentMax: {ID: 0x0105, type: DataType.INT16, min: -32767},
            dcPower: {ID: 0x0106, type: DataType.INT16, reportRequired: true, min: -32767},
            dcPowerMin: {ID: 0x0107, type: DataType.INT16, min: -32767},
            dcPowerMax: {ID: 0x0108, type: DataType.INT16, min: -32767},

            dcVoltageMultiplier: {ID: 0x0200, type: DataType.UINT16, reportRequired: true, min: 1, max: 0xffff, default: 1},
            dcVoltageDivisor: {ID: 0x0201, type: DataType.UINT16, reportRequired: true, min: 1, max: 0xffff, default: 1},
            dcCurrentMultiplier: {ID: 0x0202, type: DataType.UINT16, reportRequired: true, min: 1, max: 0xffff, default: 1},
            dcCurrentDivisor: {ID: 0x0203, type: DataType.UINT16, reportRequired: true, min: 1, max: 0xffff, default: 1},
            dcPowerMultiplier: {ID: 0x0204, type: DataType.UINT16, reportRequired: true, min: 1, max: 0xffff, default: 1},
            dcPowerDivisor: {ID: 0x0205, type: DataType.UINT16, reportRequired: true, min: 1, max: 0xffff, default: 1},

            acFrequency: {ID: 0x0300, type: DataType.UINT16, reportRequired: true},
            acFrequencyMin: {ID: 0x0301, type: DataType.UINT16},
            acFrequencyMax: {ID: 0x0302, type: DataType.UINT16},
            neutralCurrent: {ID: 0x0303, type: DataType.UINT16, reportRequired: true},
            ...
            totalApparentPower: {ID: 0x0306, type: DataType.UINT32, reportRequired: true, max: 0xffffff},
            meas1stHarmonicCurrent: {ID: 0x0307, type: DataType.INT16, reportRequired: true},
            meas3rdHarmonicCurrent: {ID: 0x0308, type: DataType.INT16, reportRequired: true},
            meas5thHarmonicCurrent: {ID: 0x0309, type: DataType.INT16, reportRequired: true},
            meas7thHarmonicCurrent: {ID: 0x030a, type: DataType.INT16, reportRequired: true},
            meas9thHarmonicCurrent: {ID: 0x030b, type: DataType.INT16, reportRequired: true},
            meas11thHarmonicCurrent: {ID: 0x030c, type: DataType.INT16, reportRequired: true},
            measPhase1stHarmonicCurrent: {ID: 0x030d, type: DataType.INT16, reportRequired: true},
            measPhase3rdHarmonicCurrent: {ID: 0x030e, type: DataType.INT16, reportRequired: true},
            measPhase5thHarmonicCurrent: {ID: 0x030f, type: DataType.INT16, reportRequired: true},
            measPhase7thHarmonicCurrent: {ID: 0x0310, type: DataType.INT16, reportRequired: true},
            measPhase9thHarmonicCurrent: {ID: 0x0311, type: DataType.INT16, reportRequired: true},
            measPhase11thHarmonicCurrent: {ID: 0x0312, type: DataType.INT16, reportRequired: true},
            ...
            powerMultiplier: {ID: 0x0402, type: DataType.UINT32, reportRequired: true, max: 0xffffff, default: 1},
            powerDivisor: {ID: 0x0403, type: DataType.UINT32, reportRequired: true, max: 0xffffff, default: 1},
            ...
            instantaneousLineCurrent: {ID: 0x0501, type: DataType.UINT16, reportRequired: true},
            instantaneousActiveCurrent: {ID: 0x0502, type: DataType.INT16, reportRequired: true},
            instantaneousReactiveCurrent: {ID: 0x0503, type: DataType.INT16, reportRequired: true},
            // XXX: does not exist?
            instantaneousPower: {ID: 0x0504, type: DataType.INT16},
            rmsVoltage: {ID: 0x0505, type: DataType.UINT16, reportRequired: true},
            rmsVoltageMin: {ID: 0x0506, type: DataType.UINT16},
            rmsVoltageMax: {ID: 0x0507, type: DataType.UINT16},
            rmsCurrent: {ID: 0x0508, type: DataType.UINT16, reportRequired: true},
            rmsCurrentMin: {ID: 0x0509, type: DataType.UINT16},
            rmsCurrentMax: {ID: 0x050a, type: DataType.UINT16},
            activePower: {ID: 0x050b, type: DataType.INT16, reportRequired: true},
            activePowerMin: {ID: 0x050c, type: DataType.INT16},
            activePowerMax: {ID: 0x050d, type: DataType.INT16},
            reactivePower: {ID: 0x050e, type: DataType.INT16, reportRequired: true},
            apparentPower: {ID: 0x050f, type: DataType.UINT16, reportRequired: true},
            ...
            lineCurrentPhB: {ID: 0x0901, type: DataType.UINT16, reportRequired: true},
            activeCurrentPhB: {ID: 0x0902, type: DataType.INT16, reportRequired: true},
            reactiveCurrentPhB: {ID: 0x0903, type: DataType.INT16, reportRequired: true},
            rmsVoltagePhB: {ID: 0x0905, type: DataType.UINT16, reportRequired: true},
            ...
            rmsCurrentPhB: {ID: 0x0908, type: DataType.UINT16, reportRequired: true},
            rmsCurrentMinPhB: {ID: 0x0909, type: DataType.UINT16},
            rmsCurrentMaxPhB: {ID: 0x090a, type: DataType.UINT16},
            activePowerPhB: {ID: 0x090b, type: DataType.INT16, reportRequired: true},
            activePowerMinPhB: {ID: 0x090c, type: DataType.INT16},
            activePowerMaxPhB: {ID: 0x090d, type: DataType.INT16},
            reactivePowerPhB: {ID: 0x090e, type: DataType.INT16, reportRequired: true},
            apparentPowerPhB: {ID: 0x090f, type: DataType.UINT16, reportRequired: true},
            ...
            lineCurrentPhC: {ID: 0x0a01, type: DataType.UINT16, reportRequired: true},
            activeCurrentPhC: {ID: 0x0a02, type: DataType.INT16, reportRequired: true},
            reactiveCurrentPhC: {ID: 0x0a03, type: DataType.INT16, reportRequired: true},
            rmsVoltagePhC: {ID: 0x0a05, type: DataType.UINT16, reportRequired: true},
            ...
            rmsCurrentPhC: {ID: 0x0a08, type: DataType.UINT16, reportRequired: true},
            rmsCurrentMinPhC: {ID: 0x0a09, type: DataType.UINT16},
            rmsCurrentMaxPhC: {ID: 0x0a0a, type: DataType.UINT16},
            activePowerPhC: {ID: 0x0a0b, type: DataType.INT16, reportRequired: true},
            activePowerMinPhC: {ID: 0x0a0c, type: DataType.INT16},
            activePowerMaxPhC: {ID: 0x0a0d, type: DataType.INT16},
            reactivePowerPhC: {ID: 0x0a0e, type: DataType.INT16, reportRequired: true},
            apparentPowerPhC: {ID: 0x0a0f, type: DataType.UINT16, reportRequired: true},
    ...
    haDiagnostic: {
        ...
        attributes: {
            ...
            // custom
            danfossSystemStatusCode: {ID: 0x4000, type: DataType.BITMAP16, manufacturerCode: ManufacturerCode.DANFOSS_A_S, writable: true},
            ...
            danfossHeatSupplyRequest: {ID: 0x4031, type: DataType.ENUM8, manufacturerCode: ManufacturerCode.DANFOSS_A_S, writable: true, max: 0xff},
            danfossSystemStatusWater: {ID: 0x4200, type: DataType.ENUM8, manufacturerCode: ManufacturerCode.DANFOSS_A_S, writable: true, max: 0xff},
            danfossMultimasterRole: {ID: 0x4201, type: DataType.ENUM8, manufacturerCode: ManufacturerCode.DANFOSS_A_S, writable: true, max: 0xff},
            danfossIconApplication: {ID: 0x4210, type: DataType.ENUM8, manufacturerCode: ManufacturerCode.DANFOSS_A_S, writable: true, max: 0xff},
