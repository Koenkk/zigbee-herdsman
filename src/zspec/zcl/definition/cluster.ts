...
export const Clusters: Readonly<Record<ClusterName, Readonly<ClusterDefinition>>> = {
    ...
    manuSpecificLumi: {
        ...
        attributes: {
            ...
            curtainTraverseTime: {ID: 0x0403, type: DataType.UINT16},
            curtainIdentifyBeep: {ID: 0x0404, type: DataType.UINT8},
            curtainLimitsCalibration: {ID: 0x0407, type: DataType.UINT8},
            curtainPosition: {ID: 0x041f, type: DataType.UINT8},
            curtainControl: {ID: 0x0420, type: DataType.UINT8},
            curtainStatus: {ID: 0x0421, type: DataType.UINT8},
            curtainLastManualOperation: {ID: 0x0425, type: DataType.UINT8},
            curtainCalibrationStatus: {ID: 0x0426, type: DataType.UINT8},
            curtainManualStop: {ID: 0x043a, type: DataType.BOOLEAN},
            curtainSpeed: {ID: 0x043b, type: DataType.UINT8},
            curtainAdaptivePullingSpeed: {ID: 0x0442, type: DataType.UINT8},
        },
        commands: {},
        commandsResponse: {},
    },
