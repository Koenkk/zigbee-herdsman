...
export const Clusters: Readonly<Record<ClusterName, Readonly<ClusterDefinition>>> = {
    ...
    liXeePrivate: {
        ...
        attributes: {
            currentTarif: {ID: 0x0000, type: DataType.CHAR_STR, write: true},
            tomorrowColor: {ID: 0x0001, type: DataType.CHAR_STR, write: true},
            scheduleHPHC: {ID: 0x0002, type: DataType.UINT8, write: true, max: 0xff},
            presencePotential: {ID: 0x0003, type: DataType.UINT8, write: true, max: 0xff},
            startNoticeEJP: {ID: 0x0004, type: DataType.UINT8, write: true, max: 0xff},
            warnDPS: {ID: 0x0005, type: DataType.UINT16, write: true, max: 0xffff},
            warnDIR1: {ID: 0x0006, type: DataType.UINT16, write: true, max: 0xffff},
            warnDIR2: {ID: 0x0007, type: DataType.UINT16, write: true, max: 0xffff},
            warnDIR3: {ID: 0x0008, type: DataType.UINT16, write: true, max: 0xffff},
            motDEtat: {ID: 0x0009, type: DataType.CHAR_STR, write: true},
            currentPrice: {ID: 0x0200, type: DataType.CHAR_STR, write: true},
            currentIndexTarif: {ID: 0x0201, type: DataType.UINT8, write: true, max: 0xff},
            currentDate: {ID: 0x0202, type: DataType.CHAR_STR, write: true},
            activeEnergyOutD01: {ID: 0x0203, type: DataType.UINT32, write: true, max: 0xffffffff},
            activeEnergyOutD02: {ID: 0x0204, type: DataType.UINT32, write: true, max: 0xffffffff},
            activeEnergyOutD03: {ID: 0x0205, type: DataType.UINT32, write: true, max: 0xffffffff},
            activeEnergyOutD04: {ID: 0x0206, type: DataType.UINT32, write: true, max: 0xffffffff},
            injectedVA: {ID: 0x0207, type: DataType.UINT16, write: true, max: 0xffff},
            injectedVAMaxN: {ID: 0x0208, type: DataType.INT16, write: true, min: -32768, max: 32767},
            injectedVAMaxN1: {ID: 0x0209, type: DataType.INT16, write: true, min: -32768, max: 32767},
            injectedActiveLoadN: {ID: 0x0210, type: DataType.INT16, write: true, min: -32768, max: 32767},
            injectedActiveLoadN1: {ID: 0x0211, type: DataType.INT16, write: true, min: -32768, max: 32767},
            drawnVAMaxN1: {ID: 0x0212, type: DataType.INT16, write: true, min: -32768, max: 32767},
            drawnVAMaxN1P2: {ID: 0x0213, type: DataType.INT16, write: true, min: -32768, max: 32767},
            drawnVAMaxN1P3: {ID: 0x0214, type: DataType.INT16, write: true, min: -32768, max: 32767},
            message1: {ID: 0x0215, type: DataType.CHAR_STR, write: true},
            message2: {ID: 0x0216, type: DataType.CHAR_STR, write: true},
            statusRegister: {ID: 0x0217, type: DataType.OCTET_STR, write: true},
            startMobilePoint1: {ID: 0x0218, type: DataType.UINT8, write: true, max: 0xff},
            stopMobilePoint1: {ID: 0x0219, type: DataType.UINT8, write: true, max: 0xff},
            startMobilePoint2: {ID: 0x0220, type: DataType.UINT8, write: true, max: 0xff},
            stopMobilePoint2: {ID: 0x0221, type: DataType.UINT8, write: true, max: 0xff},
            startMobilePoint3: {ID: 0x0222, type: DataType.UINT8, write: true, max: 0xff},
            stopMobilePoint3: {ID: 0x0223, type: DataType.UINT8, write: true, max: 0xff},
            relais: {ID: 0x0224, type: DataType.UINT16, write: true, max: 0xffff},
            daysNumberCurrentCalendar: {ID: 0x0225, type: DataType.UINT8, write: true, max: 0xff},
            daysNumberNextCalendar: {ID: 0x0226, type: DataType.UINT8, write: true, max: 0xff},
            daysProfileCurrentCalendar: {ID: 0x0227, type: DataType.LONG_OCTET_STR, write: true},
            daysProfileNextCalendar: {ID: 0x0228, type: DataType.LONG_OCTET_STR, write: true},
            linkyMode: {ID: 0x0300, type: DataType.UINT8, write: true, max: 0xff},
        },
        commands: {},
        commandsResponse: {},
    },
