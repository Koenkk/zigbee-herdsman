...
export const Clusters: Readonly<Record<ClusterName, Readonly<ClusterDefinition>>> = {
    ...
    fallDetectionOwon: {
        ...
        manufacturerCode: ManufacturerCode.OWON_TECHNOLOGY_INC,
        attributes: {
            status: {ID: 0x0000, type: DataType.ENUM8},
            breathingRate: {ID: 0x0002, type: DataType.UINT8},
            locationX: {ID: 0x0003, type: DataType.INT16},
            locationY: {ID: 0x0004, type: DataType.INT16},
            bedUpperLeftX: {ID: 0x0100, type: DataType.INT16},
            bedUpperLeftY: {ID: 0x0101, type: DataType.INT16},
            bedLowerRightX: {ID: 0x0102, type: DataType.INT16},
            bedLowerRightY: {ID: 0x0103, type: DataType.INT16},
            doorCenterX: {ID: 0x0108, type: DataType.INT16},
            doorCenterY: {ID: 0x0109, type: DataType.INT16},
            leftFallDetectionRange: {ID: 0x010c, type: DataType.UINT16},
            rightFallDetectionRange: {ID: 0x010d, type: DataType.UINT16},
            frontFallDetectionRange: {ID: 0x010e, type: DataType.UINT16},
        },
        commands: {},
        commandsResponse: {},
    },
