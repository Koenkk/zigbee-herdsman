...
export const Clusters: Readonly<Record<ClusterName, Readonly<ClusterDefinition>>> = {
    ...
    hvacThermostat: {
        ...
        attributes: {
            ...
            DanfossPreHeat: {ID: 0x4131, type: DataType.ENUM8, manufacturerCode: ManufacturerCode.DANFOSS_A_S},
            DanfossPreHeatStatus: {ID: 0x414f, type: DataType.ENUM8, manufacturerCode: ManufacturerCode.DANFOSS_A_S},
