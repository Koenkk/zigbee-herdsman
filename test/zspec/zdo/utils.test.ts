...
describe('ZDO Utils', () => {
    ...
    it.each([
        ...
        [0b00000100, {alternatePANCoordinator: 0, deviceType: 0, powerSource: 1, rxOnWhenIdle: 0, reserved1: 0, reserved2: 0, securityCapability: 0, allocateAddress: 0}],
        [0b00001000, {alternatePANCoordinator: 0, deviceType: 0, powerSource: 0, rxOnWhenIdle: 1, reserved1: 0, reserved2: 0, securityCapability: 0, allocateAddress: 0}],
        [0b00010000, {alternatePANCoordinator: 0, deviceType: 0, powerSource: 0, rxOnWhenIdle: 0, reserved1: 1, reserved2: 0, securityCapability: 0, allocateAddress: 0}],
        [0b00100000, {alternatePANCoordinator: 0, deviceType: 0, powerSource: 0, rxOnWhenIdle: 0, reserved1: 0, reserved2: 1, securityCapability: 0, allocateAddress: 0}],
        [0b01000000, {alternatePANCoordinator: 0, deviceType: 0, powerSource: 0, rxOnWhenIdle: 0, reserved1: 0, reserved2: 0, securityCapability: 1, allocateAddress: 0}],
        [0b10000000, {alternatePANCoordinator: 0, deviceType: 0, powerSource: 0, rxOnWhenIdle: 0, reserved1: 0, reserved2: 0, securityCapability: 0, allocateAddress: 1}],
        [0b10101011, {alternatePANCoordinator: 1, deviceType: 1, powerSource: 0, rxOnWhenIdle: 1, reserved1: 0, reserved2: 1, securityCapability: 0, allocateAddress: 1}],
        [0b11111111, {alternatePANCoordinator: 1, deviceType: 1, powerSource: 1, rxOnWhenIdle: 1, reserved1: 1, reserved2: 1, securityCapability: 1, allocateAddress: 1}],
    ...
    it.each([
        [0, {
            primaryTrustCenter: 0, backupTrustCenter: 0, deprecated1: 0, deprecated2: 0, deprecated3: 0, deprecated4: 0,
