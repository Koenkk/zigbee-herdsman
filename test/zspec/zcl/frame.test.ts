...
const GLOBAL_HEADER = new Zcl.Header(
    {frameType: Zcl.FrameType.GLOBAL, manufacturerSpecific: false, direction: Zcl.Direction.CLIENT_TO_SERVER, disableDefaultResponse: false, reservedBits: 0},
    null, 123, Zcl.Foundation.read.ID,
);
...
const GLOBAL_RSP_HEADER = new Zcl.Header(
    {frameType: Zcl.FrameType.GLOBAL, manufacturerSpecific: false, direction: Zcl.Direction.SERVER_TO_CLIENT, disableDefaultResponse: false, reservedBits: 0},
    null, 78, Zcl.Foundation.readRsp.ID,
);
...
const GLOBAL_CONDITION_HEADER = new Zcl.Header(
    {frameType: Zcl.FrameType.GLOBAL, manufacturerSpecific: false, direction: Zcl.Direction.SERVER_TO_CLIENT, disableDefaultResponse: false, reservedBits: 0},
    null, 78, Zcl.Foundation.configReport.ID,
);
...
const SPECIFIC_HEADER = new Zcl.Header(
    {frameType: Zcl.FrameType.SPECIFIC, manufacturerSpecific: false, direction: Zcl.Direction.CLIENT_TO_SERVER, disableDefaultResponse: false, reservedBits: 0},
    null, 44, Zcl.Clusters.genAlarms.commands.getAlarm.ID,
);
...
const SPECIFIC_CONDITION_HEADER = new Zcl.Header(
    {frameType: Zcl.FrameType.SPECIFIC, manufacturerSpecific: false, direction: Zcl.Direction.SERVER_TO_CLIENT, disableDefaultResponse: false, reservedBits: 0},
    null, 45, Zcl.Clusters.genOta.commandsResponse.queryNextImageResponse.ID,
);
...
const SPECIFIC_RSP_HEADER = new Zcl.Header(
    {frameType: Zcl.FrameType.SPECIFIC, manufacturerSpecific: false, direction: Zcl.Direction.SERVER_TO_CLIENT, disableDefaultResponse: false, reservedBits: 0},
    null, 53, Zcl.Clusters.genAlarms.commandsResponse.alarm.ID,
);
...
const MANUF_SPE_HEADER = new Zcl.Header(
    {frameType: Zcl.FrameType.GLOBAL, manufacturerSpecific: true, direction: Zcl.Direction.CLIENT_TO_SERVER, disableDefaultResponse: false, reservedBits: 0},
    Zcl.ManufacturerCode.AAC_TECHNOLOGIES_HOLDING, 234, Zcl.Foundation.read.ID,
);
...
const GLOBAL_FRAME = Zcl.Frame.create(
    GLOBAL_HEADER.frameControl.frameType, GLOBAL_HEADER.frameControl.direction, GLOBAL_HEADER.frameControl.disableDefaultResponse,
    GLOBAL_HEADER.manufacturerCode, GLOBAL_HEADER.transactionSequenceNumber, GLOBAL_HEADER.commandIdentifier,
    Zcl.Foundation.read.ID, [{attrId: 256}]/*payload*/, {}/*custom clusters*/, GLOBAL_HEADER.frameControl.reservedBits,
);
const GLOBAL_FRAME_BUFFER = Buffer.concat([GLOBAL_HEADER_BUFFER, Buffer.from(uint16To8Array(256))]);
const GLOBAL_FRAME_STRING = `{"header":{"frameControl":{"reservedBits":0,"frameType":0,"direction":0,"disableDefaultResponse":false,"manufacturerSpecific":false},"manufacturerCode":null,"transactionSequenceNumber":123,"commandIdentifier":0},"payload":[{"attrId":256}],"command":{"ID":0,"name":"read","parameters":[{"name":"attrId","type":33}],"response":1}}`;

/** Frame of Global type and response command */
const GLOBAL_RSP_FRAME = Zcl.Frame.create(
    GLOBAL_RSP_HEADER.frameControl.frameType, GLOBAL_RSP_HEADER.frameControl.direction, GLOBAL_RSP_HEADER.frameControl.disableDefaultResponse,
    GLOBAL_RSP_HEADER.manufacturerCode, GLOBAL_RSP_HEADER.transactionSequenceNumber, GLOBAL_RSP_HEADER.commandIdentifier,
    Zcl.Foundation.readRsp.ID, [{attrId: 256, status: Zcl.Status.SUCCESS, dataType: Zcl.DataType.ENUM8, attrData: 127}]/*payload*/,
    {}/*custom clusters*/, GLOBAL_RSP_HEADER.frameControl.reservedBits,
);
const GLOBAL_RSP_FRAME_BUFFER = Buffer.concat([GLOBAL_RSP_HEADER_BUFFER, Buffer.from([...uint16To8Array(256), Zcl.Status.SUCCESS, Zcl.DataType.ENUM8, 127])]);
const GLOBAL_RSP_FRAME_STRING = `{"header":{"frameControl":{"reservedBits":0,"frameType":0,"direction":1,"disableDefaultResponse":false,"manufacturerSpecific":false},"manufacturerCode":null,"transactionSequenceNumber":78,"commandIdentifier":1},"payload":[{"attrId":256,"status":0,"dataType":48,"attrData":127}],"command":{"ID":1,"name":"readRsp","parameters":[{"name":"attrId","type":33},{"name":"status","type":32},{"name":"dataType","type":32,"conditions":[{"type":"statusEquals","value":0}]},{"name":"attrData","type":1000,"conditions":[{"type":"statusEquals","value":0}]}]}}`;

/** Frame of Global type with no payload */
const GLOBAL_FRAME_NO_PAYLOAD = Zcl.Frame.create(
    GLOBAL_HEADER.frameControl.frameType, GLOBAL_HEADER.frameControl.direction, GLOBAL_HEADER.frameControl.disableDefaultResponse,
    GLOBAL_HEADER.manufacturerCode, GLOBAL_HEADER.transactionSequenceNumber, GLOBAL_HEADER.commandIdentifier,
    Zcl.Foundation.read.ID, []/*payload*/, {}/*custom clusters*/, GLOBAL_HEADER.frameControl.reservedBits,
);
const GLOBAL_FRAME_NO_PAYLOAD_BUFFER = Buffer.concat([GLOBAL_HEADER_BUFFER]);
const GLOBAL_FRAME_NO_PAYLOAD_STRING = `{"header":{"frameControl":{"reservedBits":0,"frameType":0,"direction":0,"disableDefaultResponse":false,"manufacturerSpecific":false},"manufacturerCode":null,"transactionSequenceNumber":123,"commandIdentifier":0},"payload":[],"command":{"ID":0,"name":"read","parameters":[{"name":"attrId","type":33}],"response":1}}`;

/** Frame of Global type with condition-based parameters */
const GLOBAL_CONDITION_FRAME = Zcl.Frame.create(
    GLOBAL_CONDITION_HEADER.frameControl.frameType, GLOBAL_CONDITION_HEADER.frameControl.direction, GLOBAL_CONDITION_HEADER.frameControl.disableDefaultResponse,
    GLOBAL_CONDITION_HEADER.manufacturerCode, GLOBAL_CONDITION_HEADER.transactionSequenceNumber, GLOBAL_CONDITION_HEADER.commandIdentifier,
    Zcl.Foundation.configReport.ID, [{direction: Zcl.Direction.SERVER_TO_CLIENT, attrId: 256, timeout: 10000}]/*payload*/, {}/*custom clusters*/, GLOBAL_CONDITION_HEADER.frameControl.reservedBits,
);
const GLOBAL_CONDITION_FRAME_BUFFER = Buffer.concat([GLOBAL_CONDITION_HEADER_BUFFER, Buffer.from([Zcl.Direction.SERVER_TO_CLIENT, ...uint16To8Array(256), ...uint16To8Array(10000)])]);
...
const SPECIFIC_FRAME = Zcl.Frame.create(
    SPECIFIC_HEADER.frameControl.frameType, SPECIFIC_HEADER.frameControl.direction, SPECIFIC_HEADER.frameControl.disableDefaultResponse,
    SPECIFIC_HEADER.manufacturerCode, SPECIFIC_HEADER.transactionSequenceNumber, SPECIFIC_HEADER.commandIdentifier,
    Zcl.Clusters.genAlarms.ID, {}/*payload*/, {}/*custom clusters*/, SPECIFIC_HEADER.frameControl.reservedBits,
);
const SPECIFIC_FRAME_BUFFER = Buffer.concat([SPECIFIC_HEADER_BUFFER]);
const SPECIFIC_FRAME_STRING = `{"header":{"frameControl":{"reservedBits":0,"frameType":1,"direction":0,"disableDefaultResponse":false,"manufacturerSpecific":false},"manufacturerCode":null,"transactionSequenceNumber":44,"commandIdentifier":2},"payload":{},"command":{"ID":2,"parameters":[],"name":"getAlarm"}}`;

/** Frame of Specific type and response command */
const SPECIFIC_RSP_FRAME = Zcl.Frame.create(
    SPECIFIC_RSP_HEADER.frameControl.frameType, SPECIFIC_RSP_HEADER.frameControl.direction, SPECIFIC_RSP_HEADER.frameControl.disableDefaultResponse,
    SPECIFIC_RSP_HEADER.manufacturerCode, SPECIFIC_RSP_HEADER.transactionSequenceNumber, SPECIFIC_RSP_HEADER.commandIdentifier,
    Zcl.Clusters.genAlarms.ID, {alarmcode: 246, clusterid: 3456}/*payload*/, {}/*custom clusters*/, SPECIFIC_RSP_HEADER.frameControl.reservedBits,
);
...
const SPECIFIC_CONDITION_FRAME = Zcl.Frame.create(
    SPECIFIC_CONDITION_HEADER.frameControl.frameType, SPECIFIC_CONDITION_HEADER.frameControl.direction, SPECIFIC_CONDITION_HEADER.frameControl.disableDefaultResponse,
    SPECIFIC_CONDITION_HEADER.manufacturerCode, SPECIFIC_CONDITION_HEADER.transactionSequenceNumber, SPECIFIC_CONDITION_HEADER.commandIdentifier,
    Zcl.Clusters.genOta.ID, {status: Zcl.Status.ABORT}/*payload*/, {}/*custom clusters*/, SPECIFIC_CONDITION_HEADER.frameControl.reservedBits,
);
...
const MANUF_SPE_FRAME = Zcl.Frame.create(
    MANUF_SPE_HEADER.frameControl.frameType, MANUF_SPE_HEADER.frameControl.direction, MANUF_SPE_HEADER.frameControl.disableDefaultResponse,
    MANUF_SPE_HEADER.manufacturerCode, MANUF_SPE_HEADER.transactionSequenceNumber, MANUF_SPE_HEADER.commandIdentifier,
    Zcl.Foundation.read.ID, [{attrId: 256}]/*payload*/, {}/*custom clusters*/, MANUF_SPE_HEADER.frameControl.reservedBits,
);
...
describe('ZCL Frame', () => {
    describe('Validates Parameter Condition', () => {
        ...
        it('DIRECTION_EQUAL', () => {
            expect(Zcl.Frame.conditionsValid(Zcl.Foundation.configReport.parameters[2], {direction: Zcl.Direction.CLIENT_TO_SERVER}, null)).toBeTruthy();
            expect(Zcl.Frame.conditionsValid(Zcl.Foundation.configReport.parameters[2], {direction: Zcl.Direction.SERVER_TO_CLIENT}, null)).toBeFalsy();
            expect(Zcl.Frame.conditionsValid(Zcl.Foundation.configReport.parameters[6], {direction: Zcl.Direction.SERVER_TO_CLIENT}, null)).toBeTruthy();
            expect(Zcl.Frame.conditionsValid(Zcl.Foundation.configReport.parameters[6], {direction: Zcl.Direction.CLIENT_TO_SERVER}, null)).toBeFalsy();
        });
        ...
        it('multiple including DATA_TYPE_CLASS_EQUAL', () => {
            expect(Zcl.Frame.conditionsValid(
    ...
    describe('Header', () => {
        it.each([
            [
                'global',
                {
                    frameControl: GLOBAL_HEADER.frameControl, manufacturerCode: GLOBAL_HEADER.manufacturerCode,
                    transactionSequenceNumber: GLOBAL_HEADER.transactionSequenceNumber, commandId: GLOBAL_HEADER.commandIdentifier,
                },
            ...
            [
                'global response',
                {
                    frameControl: GLOBAL_RSP_HEADER.frameControl, manufacturerCode: GLOBAL_RSP_HEADER.manufacturerCode,
                    transactionSequenceNumber: GLOBAL_RSP_HEADER.transactionSequenceNumber, commandId: GLOBAL_RSP_HEADER.commandIdentifier,
                },
            ...
            [
                'specific',
                {
                    frameControl: SPECIFIC_HEADER.frameControl, manufacturerCode: SPECIFIC_HEADER.manufacturerCode,
                    transactionSequenceNumber: SPECIFIC_HEADER.transactionSequenceNumber, commandId: SPECIFIC_HEADER.commandIdentifier,
                },
            ...
            [
                ...
                {
                    frameControl: MANUF_SPE_HEADER.frameControl, manufacturerCode: MANUF_SPE_HEADER.manufacturerCode,
                    transactionSequenceNumber: MANUF_SPE_HEADER.transactionSequenceNumber, commandId: MANUF_SPE_HEADER.commandIdentifier,
                },
            ...
            [
                ...
                {
                    frameControl: {
                        frameType: Zcl.FrameType.GLOBAL, manufacturerSpecific: false,
                        direction: Zcl.Direction.CLIENT_TO_SERVER, disableDefaultResponse: true, reservedBits: 0,
                    },
                    manufacturerCode: null, transactionSequenceNumber: 234, commandId: 1,
                },
            ...
            [
                'reserved bits - non-compliant use',
                {
                    frameControl: {
                        frameType: Zcl.FrameType.GLOBAL, manufacturerSpecific: false,
                        direction: Zcl.Direction.CLIENT_TO_SERVER, disableDefaultResponse: false, reservedBits: 7,
                    },
                    manufacturerCode: null, transactionSequenceNumber: 234, commandId: 1,
                },
            ...
            [
                ...
                {
                    frameControl: {
                        frameType: Zcl.FrameType.SPECIFIC, manufacturerSpecific: true,
                        direction: Zcl.Direction.CLIENT_TO_SERVER, disableDefaultResponse: false, reservedBits: 0,
                    },
                    manufacturerCode: Zcl.ManufacturerCode.S3C, transactionSequenceNumber: 234, commandId: 1,
                },
            ...
            [
                'all non-zero - non-compliant use of reservedBits',
                {
                    frameControl: {
                        frameType: Zcl.FrameType.SPECIFIC, manufacturerSpecific: true,
                        direction: Zcl.Direction.SERVER_TO_CLIENT, disableDefaultResponse: true, reservedBits: 3,
                    },
                    manufacturerCode: Zcl.ManufacturerCode.BOSCH_SECURITY_SYSTEMS_INC, transactionSequenceNumber: 234, commandId: 1,
                },
        ...
        it.each([
            ...
            [
                'manufacturer specific',
                {value: [4, ...uint16To8Array(1234), 234]},
            ],
    ...
    it.each([
        [
            'global',
            GLOBAL_FRAME,
            {string: GLOBAL_FRAME_STRING, header: GLOBAL_HEADER, written: GLOBAL_FRAME_BUFFER},
        ],
        [
            'global response',
            GLOBAL_RSP_FRAME,
            {string: GLOBAL_RSP_FRAME_STRING, header: GLOBAL_RSP_HEADER, written: GLOBAL_RSP_FRAME_BUFFER},
        ],
        [
            'global no payload',
        ...
        [
            'specific',
            SPECIFIC_FRAME,
            {string: SPECIFIC_FRAME_STRING, header: SPECIFIC_HEADER, written: SPECIFIC_FRAME_BUFFER},
        ],
        [
            'specific response',
            SPECIFIC_RSP_FRAME,
        ...
        [
            'manufacturer-specific',
            MANUF_SPE_FRAME,
            {string: MANUF_SPE_FRAME_STRING, header: MANUF_SPE_HEADER, written: MANUF_SPE_FRAME_BUFFER},
        ],
    ...
    it('Writes & Reads repetitive strategy', () => {
        ...
        const frame = Zcl.Frame.create(
            header.frameControl.frameType, header.frameControl.direction, header.frameControl.disableDefaultResponse,
            header.manufacturerCode, header.transactionSequenceNumber, header.commandIdentifier,
    ...
    it('Writes & Reads flat strategy', () => {
        ...
        const header = new Zcl.Header(
            {frameType: Zcl.FrameType.GLOBAL, manufacturerSpecific: false, direction: Zcl.Direction.CLIENT_TO_SERVER, disableDefaultResponse: false, reservedBits: 0},
            null, 123, Zcl.Foundation.defaultRsp.ID,
        );
        const frame = Zcl.Frame.create(
            header.frameControl.frameType, header.frameControl.direction, header.frameControl.disableDefaultResponse,
            header.manufacturerCode, header.transactionSequenceNumber, header.commandIdentifier,
    ...
    it('Writes & Reads oneof strategy', () => {
        const expected = {
            discComplete: 123,
            attrInfos: [{attrId: 32, dataType: Zcl.DataType.UINT16}, {attrId: 67, dataType: Zcl.DataType.ARRAY}]
        };
        const header = new Zcl.Header(
            {frameType: Zcl.FrameType.GLOBAL, manufacturerSpecific: false, direction: Zcl.Direction.CLIENT_TO_SERVER, disableDefaultResponse: false, reservedBits: 0},
            null, 123, Zcl.Foundation.discoverRsp.ID,
        );
        const frame = Zcl.Frame.create(
            header.frameControl.frameType, header.frameControl.direction, header.frameControl.disableDefaultResponse,
            header.manufacturerCode, header.transactionSequenceNumber, header.commandIdentifier,
    ...
    it('Throws when writting invalid frame type', () => {
        expect(() => {
            const frame = Zcl.Frame.create(
                ...
                3,
                Zcl.Direction.CLIENT_TO_SERVER, false, null, 123,
                Zcl.Clusters.genAlarms.commands.reset.ID, Zcl.Clusters.genAlarms.ID,
                {}/*payload*/, {}/*custom clusters*/, 0/*reserved bits*/
            );
    ...
    it('Throws when reading invalid frame type', () => {
        expect(() => {
            Zcl.Frame.fromBuffer(
                ...
                Buffer.from([])/*payload*/, {}/*custom clusters*/,
            );
    ...
    it('[workaround] Reads Foundation char str as Mi struct for Xiaomi attridId=65281', () => {
        ...
        const buffer = Buffer.from([
            28, ...uint16To8Array(Zcl.ManufacturerCode.LUMI_UNITED_TECHOLOGY_LTD_SHENZHEN), 3, 10,/*header*/
            // regular attr parsing
            5, 0, Zcl.DataType.CHAR_STR, 21, 108, 117, 109, 105, 46, 115, 101, 110, 115, 111, 114, 95, 119, 108, 101, 97, 107, 46, 97, 113, 49,
            // workaround parsing
            1, 255, Zcl.DataType.CHAR_STR,
            34,
    ...
    it('[workaround] Reads Foundation struct with extra payload to match zcl-packet', () => {
        const expected = [{
            attrId: 65282, dataType: Zcl.DataType.STRUCT, numElms: 6,
            structElms: [
        ...
        const buffer = Buffer.from([
            28, ...uint16To8Array(Zcl.ManufacturerCode.DSR_CORPORATION), 194, 10,/*header*/
            ...uint16To8Array(65282), Zcl.DataType.STRUCT, 6, 0,
            Zcl.DataType.BOOLEAN, 1,
            Zcl.DataType.UINT16, ...uint16To8Array(3022),
            Zcl.DataType.UINT16, ...uint16To8Array(17320),
            Zcl.DataType.UINT40, ...uint32To8Array(1), 0,
            Zcl.DataType.UINT16, ...uint16To8Array(560),
            Zcl.DataType.UINT8, 86,
        ]);
        const header = Zcl.Header.fromBuffer(buffer)!;
        const frame = Zcl.Frame.fromBuffer(0/*Foundation*/, header, buffer, {});
