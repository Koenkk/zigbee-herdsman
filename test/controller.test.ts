...
describe('Controller', () => {
    ...
    it('Poll control unsupported', async () => {
        ...
        expect(device.defaultSendRequestWhen).toEqual(undefined);
    });
