...
describe('Controller', () => {
    ...
    it('Allow to override read response through `device.customReadResponse', async () => {
        ...
        await mockAdapterEvents['data'](payload);
    ...
    it('Write to device with pendingRequestTimeout > 0', async () => {
        ...
        await nextTick;
        await mockAdapterEvents['data'](data);
        await result;
