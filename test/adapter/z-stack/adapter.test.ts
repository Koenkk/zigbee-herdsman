...
describe("zstack-adapter", () => {
    ...
    it('LQI fails', async () => {
        ...
        expect(error).toStrictEqual(new Error("LQI for '204' failed with error: 'FAILURE' (status code 1)"));
    ...
    it('Routing table fails', async () => {
        ...
        expect(error).toStrictEqual(new Error("Routing table for '206' failed with error: 'FAILURE' (status code 1)"));
