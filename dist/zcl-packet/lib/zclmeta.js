/* jshint node: true */
'use strict';
var Enum = require('enum'), zclId = require('../../zcl-id');
var zclMeta = require('./defs/zcl_meta.json'), zclDefs = require('./defs/zcl_defs.json');
var zclmeta = {
    foundation: {},
    functional: {},
...
zclmeta.foundation.getParams = function (cmd) {
    var meta = this.get(cmd), params = meta ? meta.params : meta; // [ { name: type }, .... ]
    if (params)
...
zclmeta.functional.getParams = function (cluster, cmd) {
    var meta = this.get(cluster, cmd), params = meta ? meta.params : meta; // [ { name: type }, .... ]
    if (params)
        return cloneParamsWithNewFormat(params);
    else
        return;
...
//# sourceMappingURL=zclmeta.js.map