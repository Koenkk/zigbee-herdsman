/* jshint node: true */
'use strict';
var _ = require('busyman'), zclId = require('zcl-id'), foundApis = require('./foundation_apis');
/*************************************************************************************************/
/*** Zive Class                                                                                ***/
/*************************************************************************************************/
...
Zive.prototype.foundationHandler = function (msg) {
    var self = this, clusters = this.clusters, data = msg.zclMsg, cId = msg.clusterid, cmdName = zclId.foundation(data.cmdId).key, cfg = {
...
Zive.prototype.functionalHandler = function (msg, remoteEp) {
    var self = this, data = msg.zclMsg, cId = msg.clusterid, cmdId = data.cmdId, cmdDir = data.frameCntl.direction, defaultRsp = data.frameCntl.disDefaultRsp, cfg = {
        manufSpec: data.frameCntl.manufSpec,
        ...
        cmdId: cmdId,
        statusCode: null
    }, cmdType, cmdName, cmdRspId, cmdRspName;
