/* jshint node: true */
'use strict';
var ZSC = require('../../zstack-constants'), NVID8 = ZSC.SAPI.nvItemIdsUint8, NVID16 = ZSC.SYS.nvItemIds;
var nvParams = {
    startupOption: {
        id: NVID8.STARTUP_OPTION,
        len: 0x01,
        offset: 0x00,
        value: [0x00]
    },
    ...
    precfgkey: {
        configid: NVID8.PRECFGKEY,
        len: 0x10,
        value: [0x01, 0x03, 0x05, 0x07, 0x09, 0x0B, 0x0D, 0x0F, 0x00, 0x02, 0x04, 0x06, 0x08, 0x0A, 0x0C, 0x0D]
    },
    precfgkeysEnable: {
        id: NVID8.PRECFGKEYS_ENABLE,
        len: 0x01,
        offset: 0x00,
        value: [0x00]
    ...
    zdoDirectCb: {
        id: NVID8.ZDO_DIRECT_CB,
        len: 0x01,
        offset: 0x00,
        value: [0x01]
    },
    securityMode: {
        id: NVID16.TCLK_TABLE_START,
        offset: 0x00,
        len: 0x20,
...
//# sourceMappingURL=nv_start_options.js.map