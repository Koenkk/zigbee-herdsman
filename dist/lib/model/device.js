...
Device.prototype.update = function (info) {
    var self = this, infoKeys = ['type', 'ieeeAddr', 'nwkAddr', 'manufId', 'epList', 'zclVersion', 'appVersion', 'stackVersion', 'hwVersion', 'swBuildId', 'status', 'joinTime', 'manufName', 'modelId', 'powerSource', 'dateCode'];
