/* jshint node: true */
'use strict';
var zdoHelper = {}, zdoReqRspMap, zdoIndSuffix;
zdoReqRspMap = {
    nwkAddrReq: { ind: 'nwkAddrRsp', apiType: 'concat', suffix: ['ieeeaddr', 'startindex'] },
    ieeeAddrReq: { ind: 'ieeeAddrRsp', apiType: 'concat', suffix: ['shortaddr'] },
...
zdoHelper.generateEventOfRequest = function (reqName, valObj) {
    var meta = zdoReqRspMap[reqName], evtName;
...
zdoHelper.generateEventOfIndication = function (indName, msgData) {
    var meta = zdoIndSuffix[indName], evtName;
    evtName = 'ZDO:' + indName;
...
//# sourceMappingURL=zdo_helper.js.map