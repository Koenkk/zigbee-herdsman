/* jshint node: true */
'use strict';
var Q = require('q'), Areq = require('../../areq'), znp = require('../../cc-znp'), ZSC = require('../../zstack-constants');
...
Zdo.prototype._genericRequest = function (apiName, valObj, callback) {
    var deferred = Q.defer(), areq = this._areq, areqEvtKey = zdoHelper.generateEventOfRequest(apiName, valObj);
    if (areqEvtKey)
...
Zdo.prototype._concatAddrRequest = function (apiName, valObj, callback) {
    var self = this, totalToGet = null, accum = 0, nextIndex = valObj.startindex, reqObj = {
