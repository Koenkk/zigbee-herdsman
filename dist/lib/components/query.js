/* jshint node: true */
'use strict';
var Q = require('q'), _ = require('busyman'), zclId = require('../../zcl-id'), proving = require('proving'), ZSC = require('../../zstack-constants');
var Endpoint = require('../model/endpoint'), Coordpoint = require('../model/coordpoint'), zutils = require('./zutils');
...
query.deviceWithEndpoints = function (nwkAddr, ieeeAddr, callback) {
    var deferred = Q.defer(), epQueries = [], fullDev;
...
query.setBindingEntry = function (bindMode, srcEp, cId, dstEpOrGrpId, callback) {
    var deferred = Q.defer(), cIdItem = zclId.cluster(cId), bindParams, dstEp, grpId, req;
...
function addrBuf2Str(buf) {
    var val, bufLen = buf.length, strChunk = '0x';
