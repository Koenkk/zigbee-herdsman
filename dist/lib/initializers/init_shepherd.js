/* jshint node: true */
'use strict';
var Q = require('q'), debug = require('debug')('zigbee-shepherd:init');
var af = require('../components/af'), loader = require('../components/loader');
var init = {};
init.setupShepherd = function (shepherd, callback) {
    var deferred = Q.defer(), controller = shepherd.controller, netInfo;
...
module.exports = init;
//# sourceMappingURL=init_shepherd.js.map